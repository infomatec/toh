	...
	("upgrade_troops", 0, mesh_face_gen_window, [
		(ti_on_presentation_load,
		  [
			...
			(else_try),
				#----------------------
				#(is_between, ":troop_no", tohlobarian_heavy_troop_begin, tohlobarian_heavy_troop_end),
				#----------------------
			...
			#(party_get_slot, "$g_talk_troop_relation", "$current_town", slot_town_prosperity),
			...
			(try_begin),
				...
				(try_begin),
					...
					(assign, ":upgrade_troop", "trp_cavalryman"),
          (assign, ":extra_cost", 300),
				(else_try),
					(eq, "$t_troop","trp_archer"),
				...
				(else_try),
					(eq, "$t_troop","trp_veteran_pikeman"),
					(assign, ":upgrade_troop", "trp_halberdier"),
					(assign, ":extra_cost", 50),
				(else_try),
					(eq, "$t_troop","trp_veteran_crossbowman"),
					(assign, ":upgrade_troop", "trp_sapper"),
					(assign, ":extra_cost", 100),
				(else_try),
				...
				(else_try),
					...
					(assign, ":upgrade_troop", "trp_light_infantry"),
					(assign, ":extra_cost", 150),
				(else_try),
					(eq, "$t_troop","trp_imprisoned_veteran"),
					(assign, ":upgrade_troop", "trp_sergeant"),
					(assign, ":extra_cost", 200),
				(else_try),
					(assign, ":condition",0),
					(eq, "$t_troop","trp_imprisoned_nobleman"),
					(assign, ":upgrade_troop", "trp_veteran_cavalryman"),
					(assign, ":extra_cost", 400),
					#-- conditions for upgrade : knight
					(create_text_overlay, reg1, "@You must be a king so that the noble ones follow you", tf_with_outline),
					(position_set_x, pos1, 100),
					(position_set_y, pos1, 590),
					(overlay_set_position, reg1, pos1),
					(overlay_set_color, reg1, 0xad1919),
					#--
					(faction_slot_eq, "fac_player_supporters_faction", slot_faction_state, sfs_active),
					(assign, ":condition", 1),
				(else_try),
					(eq, "$t_troop","trp_elite_foot_soldier"),
					(assign, ":upgrade_troop", "trp_knight"),
					(assign, ":extra_cost", 400),
					#-- conditions for upgrade : knight
					(create_text_overlay, reg1, "@{playername} must possess a fiefdom to ennoble commoners", tf_with_outline),
					(position_set_x, pos1, 100),
					(position_set_y, pos1, 590),
					(overlay_set_position, reg1, pos1),
					(overlay_set_color, reg1, 0xad1919),
					...
					(try_end),
				(else_try),
					(eq, "$t_troop","trp_veteran_cavalryman"),
					(assign, ":upgrade_troop", "trp_knight"),
					(assign, ":extra_cost", 400),
					#-- conditions for upgrade : knight
					(create_text_overlay, reg1, "@{playername} must possess a fiefdom to ennoble commoners", tf_with_outline),
					...
					(position_set_y, pos1, 590),
					(overlay_set_position, reg1, pos1),
					(overlay_set_color, reg1, 0xcad1919),
					#--
					#(faction_slot_eq, "fac_player_supporters_faction", slot_faction_state, sfs_active),
					(try_begin),
					      (assign, ":result", -1),
					...
					(try_end),
				(else_try),
					(eq, "$t_troop","trp_bachelor"),
					(assign, ":upgrade_troop", "trp_banneret"),
					(assign, ":extra_cost", 500),
					#(faction_slot_eq, "fac_player_supporters_faction", slot_faction_state, sfs_active),
					#-- conditions for upgrade : banneret
					(create_text_overlay, reg1, "@Must own at least 1 fief for every Banneret", tf_with_outline),
					(position_set_x, pos1, 100),
					(position_set_y, pos1, 590),
					(overlay_set_position, reg1, pos1),
					(overlay_set_color, reg1, 0xad1919),
					...
					(try_for_range, ":center", centers_begin, centers_end),
						...
						(val_add, ":fief_found", 1),
					(try_end),
					(call_script, "script_main_party_bannerets"),
					(assign, ":num_main_party_bannerets", reg0),
 					(gt, ":fief_found", ":num_main_party_bannerets"),
					(assign, ":condition", 1),
				(try_end),
				#----------------------------------------------
				#(troop_get_upgrade_troop, ":upgrade_troop", "$t_troop", 0),
				(gt, ":upgrade_troop", 0),
				(troop_set_slot, "trp_temp_array_b", 1, ":upgrade_troop"),
				#-- conditions for upgrade
				# (create_text_overlay, reg1, "@Condition to upgrade :", tf_with_outline),
				# (position_set_x, pos1, 100),
				...
				#--
				#-- upgraded troop
				(store_mul, ":u_troop", ":upgrade_troop", 2), #with weapons
				(create_image_button_overlay_with_tableau_material, "$g_presentation_obj_8", -1, "tableau_game_party_window", ":u_troop"),
				(position_set_x, pos1, 875),#--1750
				(position_set_y, pos1, 875),#--1750
				...
				(create_image_button_overlay, "$g_presentation_obj_11", "mesh_icon_arrow_left", "mesh_icon_arrow_left"),
				(overlay_set_size, "$g_presentation_obj_11", pos1),
				(position_set_x, pos1, 350),
				(position_set_y, pos1, 400),
				(overlay_set_position, "$g_presentation_obj_11", pos1),
				#(overlay_set_tooltip, "$g_presentation_obj_11", "@Click here to upgrade troop"),
				#--
				#-- calculate cost
				...
				#--
				#-- conditions for upgrade : cost
				(create_text_overlay, reg1, "@{s1} ", tf_single_line),
				(position_set_x, pos1, 250),#--100
				(position_set_y, pos1, 350),
				(overlay_set_position, reg1, pos1),
				(overlay_set_color, reg1, 0x3a4b3a),
				#--
				(eq,":condition", 1),
			  ...
			  #(try_begin),
				#(troop_get_upgrade_troop, ":upgrade_troop", "$t_troop", 1),
				#(gt, ":upgrade_troop", 0),
			...
			(else_try), #default, startup
			  (create_mesh_overlay, "$g_presentation_obj_6", "mesh_pic_mb_weapons"),
  ...
  ("game_profile_banner_selection", 0, mesh_load_window, [
    ...
    (ti_on_presentation_event_state_change, [
      ...
      (try_begin),
        ...
        (val_mod, "$g_presentation_page_no", 8),#--8
        (presentation_set_duration, 0),

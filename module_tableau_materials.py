...
#---------------------------------------------------------
#--toh heraldic
  ("heraldic_churburg", 0, "sample_heraldic_churburg", 512, 512, 0, 0, 0, 0,
   [
       (store_script_param, ":banner_mesh", 1),
       ...
       (init_position, pos1),
       (position_set_z, pos1, 30),
       (cur_tableau_add_mesh, "mesh_tableau_mesh_heraldic_churburg_banner", pos1, 0, 0),
       (cur_tableau_set_camera_parameters, 0, 200, 200, 0, 100000),
       ]),

  ("heraldic_corrazina", 0, "heraldic_corrazina_sample", 512, 512, 0, 0, 0, 0,
   [
       (store_script_param, ":banner_mesh", 1),
       ...
       (init_position, pos1),
       (position_set_z, pos1, 30),
       (cur_tableau_add_mesh, "mesh_tableau_mesh_heraldic_corrazina_banner", pos1, 0, 0),
       (cur_tableau_set_camera_parameters, 0, 200, 200, 0, 100000),
       ]),	   
	   

  # ("heraldic_gothic_armor", 0, "heraldic_gothic_armour_sample", 1024, 1024, 0, 0, 0, 0,
   # [
       # (store_script_param, ":banner_mesh", 1),
       ...
       # (position_set_z, pos1, 50),
       # (position_set_x, pos1, 10),
       # (position_set_y, pos1, 100),#130#165
       # (cur_tableau_add_mesh, ":banner_mesh", pos1, 40, 0),
       # (init_position, pos1),
       # (position_set_z, pos1, 30),
       # (cur_tableau_add_mesh, "mesh_tableau_mesh_gothic_armor_banner", pos1, 0, 0),
       # (cur_tableau_set_camera_parameters, 0, 200, 200, 0, 100000),
       # ]),
...
##     ]),
  ...
  ("retirement_troop", 0, "tableau_with_transparency", 2048, 2048, 0, 0, 600, 600,
   [
	...
	###
	#--
	  ("toh_brigandine_heraldic_new", 0, "sample_toh_brigandine_heraldic", 512, 512, 0, 0, 0, 0,
	   [
		   (store_script_param, ":banner_mesh", 1),
	...
	#       (cur_tableau_add_mesh, "mesh_banner_a01", pos1, 116, 0),
		   (init_position, pos1),
		   (position_set_z, pos1, 100),
		   (cur_tableau_add_mesh, "mesh_tableau_mesh_toh_brigandine_heraldic", pos1, 0, 0),
		   (cur_tableau_set_camera_parameters, 0, 200, 200, 0, 100000),
		   ]),
	#--	
	###
...
#--
#-- cwe heraldic shields
  # ("shield_lobarian_knight", 0, "sample_tableau_lobarian_knight_shield", 1024, 1024, 0, 0, 0, 0,
   # [   (store_script_param, ":banner_mesh", 1),
       # (set_fixed_point_multiplier, 100),
       # (init_position, pos1),
       # (position_set_x, pos1, -50),
       ...
       # (init_position, pos1),
       # (position_set_z, pos1, 10),
       # (cur_tableau_add_mesh, "mesh_tableau_mesh_lobarian_knight_shield", pos1, 0, 0),
       # (cur_tableau_set_camera_parameters, 0, 200, 200, 0, 100000),
       # ])
...
#--
	  ("heraldic_jarl_armor", 0, "huscarl_armour", 1024, 1024, 0, 0, 0, 0,
	   [
		   (store_script_param, ":banner_mesh", 1),
		   (set_fixed_point_multiplier, 100),
			(store_sub, ":background_slot", ":banner_mesh", arms_meshes_begin), #banner_meshes_begin),
		   ...
		   (cur_tableau_set_background_color, ":background_color"),
		   (init_position, pos1),
		   (cur_tableau_add_mesh_with_vertex_color, "mesh_heraldic_armor_bg_new", pos1, 100, 100, ":background_color"),
		   (init_position, pos1),
		   (position_set_x, pos1, -29), #-59
		   (position_set_y, pos1, 180),
		   (cur_tableau_add_mesh, ":banner_mesh", pos1, 113, 0),#113
		   (init_position, pos1),
		   (position_set_z, pos1, 100),
		   (cur_tableau_add_mesh, "mesh_tableau_mesh_heraldic_jarl_armor", pos1, 0, 0),
		   (cur_tableau_set_camera_parameters, 0, 200, 200, 0, 100000),
		   ])

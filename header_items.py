...
### Poleaxe ### #--parer/deux_mains_haute/attaque_basse/ballayage_droite/ballayage_gauche 
itc_poleaxe    = itc_parry_polearm| itcf_overswing_twohanded |itcf_thrust_polearm|itcf_slashright_polearm|itcf_slashleft_polearm

### Spears ### #--parer/attaque_basse_lance/attaque_basse_lance_a_cheval/attaque_haute/attaque_haute_pike/attaque_basse 
itc_staff      = itc_parry_polearm| itcf_thrust_onehanded_lance |itcf_thrust_onehanded_lance_horseback | itcf_overswing_musket | itcf_overswing_polearm |itcf_thrust_polearm
...
### Lances ### #--parer/lance_a_pied/lance_a_cheval/attaque_basse 
itc_spear      = itc_parry_polearm| itcf_thrust_onehanded_lance |itcf_thrust_onehanded_lance_horseback | itcf_thrust_polearm 

### Pikes ### #--SPEAR + attaque_haute_pike 
itc_cutting_spear = itc_spear|itcf_overswing_polearm

### Pike a cheval sans parer ### #--lance_a_pied/lance_a_cheval/attaque_basse = 
#itc_pike       = itcf_thrust_onehanded_lance |itcf_thrust_onehanded_lance_horseback | itcf_thrust_polearm
### veritable Pikes
itc_pike       = itc_parry_polearm|itcf_overswing_polearm | itcf_thrust_polearm

### Hafted blades ### #--parer/deux_mains_haute/attaque_basse/ballayage_droite/ballayage_gauche/ballayage_droite_a_cheval/ballayage_gauche_a_cheval/ballayage_a_cheval  
itc_guandao    = itc_parry_polearm|itcf_overswing_twohanded|itcf_thrust_polearm|itcf_slashright_polearm|itcf_slashleft_polearm|itcf_horseback_slashright_onehanded|itcf_horseback_slashleft_onehanded|itcf_horseback_slash_polearm

#--attaque_basse_lance/attaque_basse_lance_a_chval/attaque_basse =  lances

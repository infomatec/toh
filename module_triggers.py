...
#(toh 0.51) Refresh questmasters inventory
  (0.0, 0, 168.0, [],
  [
    (call_script, "script_refresh_quartermasters_inventory"),
  ]), 
...
#  (4.1, 0, 0.0, [],
#                     [
#                         (assign, "$pin_faction", "fac_pravars"),
#                         (assign, "$pin_party_template", "pt_pravar_prisoner_train"),
...
#  (4.1, 0, 0.0, [],
#                     [
#                         (assign, "$pin_faction", "fac_borovods"),
#                         (assign, "$pin_party_template", "pt_borovod_prisoner_train"),
#                         (assign, "$pin_limit", peak_prisoner_trains),
#                         (call_script,"script_cf_spawn_party_at_faction_town_if_below_limit"),
#                         (party_set_ai_behavior,"$pout_party",ai_bhvr_travel_to_party),
#                         (party_set_ai_object,"$pout_party","$pout_town"),
...
#                     [
#                         (assign, "$pin_faction", "fac_pravars"),
#                         (assign, "$pin_party_template", "pt_pravar_caravan"),
...
#                     [
#                         (assign, "$pin_faction", "fac_borovods"),
#                         (assign, "$pin_party_template", "pt_borovod_caravan"),
#                         (assign, "$pin_limit", peak_kingdom_caravans),
#                         (call_script,"script_cf_spawn_party_at_faction_town_if_below_limit"),
#                         (party_set_ai_behavior,"$pout_party",ai_bhvr_travel_to_party),
#                         (party_set_ai_object,"$pout_party","$pout_town"),
...
#  (4.2, 0, 0.0, [],
#   [(assign, "$pin_faction", "fac_pravars"),
#    (assign, "$pin_party_template", "pt_pravar_messenger"),
...
#  (4.2, 0, 0.0, [],
#   [(assign, "$pin_faction", "fac_borovods"),
#    (assign, "$pin_party_template", "pt_borovod_messenger"),
#    (assign, "$pin_limit", peak_kingdom_caravans),
#    (call_script,"script_cf_spawn_party_at_faction_town_if_below_limit"),
#    (party_set_ai_behavior,"$pout_party",ai_bhvr_travel_to_party),
#    (party_set_ai_object,"$pout_party","$pout_town"),
...
#                     [
#                         (assign, "$pin_faction", "fac_pravars"),
#                         (assign, "$pin_party_template", "pt_pravar_deserters"),
#                         (assign, "$pin_limit", 4),
#                         (call_script,"script_cf_spawn_party_at_faction_town_if_below_limit"),
#                    ]),
...
#                     [
#                         (assign, "$pin_faction", "fac_borovods"),
#                         (assign, "$pin_party_template", "pt_borovod_deserters"),
#                         (assign, "$pin_limit", 4),
#                         (call_script,"script_cf_spawn_party_at_faction_town_if_below_limit"),
#                    ]),
...
#Kingdom Parties
  (1.0, 0, 0.0, [],
   [(try_for_range, ":cur_kingdom", kingdoms_begin, kingdoms_end),
	  ...
	  (neq,":cur_kingdom","fac_kingdom_8"),#<--- pas de caravane pour la West Trade Company
...
#Pravars
#  (0.0, 0.0, ti_once, [], [(assign,"$peak_pravar_foragers",4)]),
#  (0.0, 0.0, ti_once, [], [(assign,"$peak_pravar_scouts",4)]),
#  (0.0, 0.0, ti_once, [], [(assign,"$peak_pravar_harassers",3)]),
#  (0.0, 0.0, ti_once, [], [(assign,"$peak_pravar_war_parties",2)]),


#  (10.2, 0, 0.0, [],
#                     [
#                         (assign, "$pin_faction", "fac_pravars"),
#                         (assign, "$pin_party_template", "pt_pravar_foragers"),
#                         (assign, "$pin_limit", "$peak_pravar_foragers"),
#                         (call_script,"script_cf_spawn_party_at_faction_town_if_below_limit"),
#                    ]),
...
#                     [
#                         (assign, "$pin_faction", "fac_pravars"),
#                         (assign, "$pin_party_template", "pt_pravar_scouts"),
#                         (assign, "$pin_limit", "$peak_pravar_scouts"),
#                         (call_script,"script_cf_spawn_party_at_faction_town_if_below_limit"),
#                    ]),
...
#                     [
#                         (assign, "$pin_faction", "fac_pravars"),
#                         (assign, "$pin_party_template", "pt_pravar_patrol"),
#                         (assign, "$pin_limit", "$peak_pravar_harassers"),
#                         (call_script,"script_cf_spawn_party_at_faction_town_if_below_limit"),
#                    ]),
...
#                     [
#                         (assign, "$pin_faction", "fac_pravars"),
#                         (assign, "$pin_party_template", "pt_pravar_war_party"),
#                         (assign, "$pin_limit", "$peak_pravar_war_parties"),
#                         (call_script,"script_cf_spawn_party_at_faction_town_if_below_limit"),
#                    ]),
#Borovods
#  (0.0, 0.0, ti_once, [], [(assign,"$peak_borovod_foragers",4)]),
#  (0.0, 0.0, ti_once, [], [(assign,"$peak_borovod_scouts",4)]),
#  (0.0, 0.0, ti_once, [], [(assign,"$peak_borovod_harassers",3)]),
#  (0.0, 0.0, ti_once, [], [(assign,"$peak_borovod_war_parties",2)]),
  

#  (10.2, 0, 0.0, [],
#                     [
#                         (assign, "$pin_faction", "fac_borovods"),
#                         (assign, "$pin_party_template", "pt_borovod_foragers"),
#                         (assign, "$pin_limit", "$peak_borovod_foragers"),
#                         (call_script,"script_cf_spawn_party_at_faction_town_if_below_limit"),
#                    ]),
...
#                     [
#                         (assign, "$pin_faction", "fac_borovods"),
#                         (assign, "$pin_party_template", "pt_borovod_scouts"),
#                         (assign, "$pin_limit", "$peak_borovod_scouts"),
#                         (call_script,"script_cf_spawn_party_at_faction_town_if_below_limit"),
#                    ]),
...
#                     [
#                         (assign, "$pin_faction", "fac_borovods"),
#                         (assign, "$pin_party_template", "pt_borovod_patrol"),
#                         (assign, "$pin_limit", "$peak_borovod_harassers"),
#                         (call_script,"script_cf_spawn_party_at_faction_town_if_below_limit"),
#                    ]),
...
#                     [
#                         (assign, "$pin_faction", "fac_borovods"),
#                         (assign, "$pin_party_template", "pt_borovod_war_party"),
#                         (assign, "$pin_limit", "$peak_borovod_war_parties"),
#                         (call_script,"script_cf_spawn_party_at_faction_town_if_below_limit"),
#                    ]),
...
##   
##   [
##       (assign,"$borcha_arrive_burfell_as_prisoner", 1),
...
#jalik's renegade mercenaries 
(1, 0, ti_once, [(check_quest_active, "qst_renegade_mercenaries"),
                   (neg|check_quest_succeeded, "qst_renegade_mercenaries"),
                   (store_num_parties_destroyed, ":cur_eliminated", "pt_jalik_patrol"),
                   (lt, "$qst_renegade_mercenaries_eliminated", ":cur_eliminated"),
                   (store_num_parties_destroyed_by_player, ":cur_eliminated_by_player", "pt_jalik_patrol"),
                   (neq, ":cur_eliminated_by_player", "$qst_renegade_mercenaries_eliminated_by_player"),
                   ],
                  [(call_script, "script_succeed_quest", "qst_renegade_mercenaries"),]),


#--player level triggers
## jalik
(24 * 7, 0, ti_once, [
					 (this_or_next|check_quest_succeeded, "qst_the_phoenix_6"),
					 (faction_slot_eq, "fac_player_supporters_faction", slot_faction_state, sfs_active),
                   ],
                  [
					 (remove_troop_from_site,"trp_jalik","scn_free_port_center"),
					 (spawn_around_party,"p_free_port","pt_jalik_army"),
					 (call_script, "script_change_player_relation_with_faction_ex", "fac_jalik_mercenaries", -10),
				  ]),				  
...
# Lady of the lake achievement
  ...
  (24*14, 4.0, ti_once, [(check_quest_active, "qst_the_phoenix_4"), ],
                [(display_message, "@ Your castle is ready !",0x259b6a ),
				  #----------outpost-----------
				  
				(disable_party,"p_ruins"),
				(enable_party,"p_village_111"),
				#(call_script, "script_update_volunteer_troops_in_village", "p_village_111"),
				(enable_party,"p_outpost"),
				  (call_script, "script_succeed_quest", "qst_the_phoenix_4"),
					(call_script, "script_end_quest", "qst_the_phoenix_4"),
					(party_add_members, "p_outpost", "trp_jalik_mercenary", 10),
					#(call_script, "script_give_center_to_lord", "p_outpost", -1, 0),
					...
					(call_script, "script_give_center_to_lord", "p_village_111", "trp_player", 0),
					(call_script, "script_give_center_to_faction_aux", "p_village_111", "fac_player_supporters_faction"),
					(assign, "$g_player_fortress",1),
					#-----------------------------
	...
	#----------------------------------------------
   #--------fortification chateau--------------------
  (24*14, 4.0, ti_once, [(check_quest_active, "qst_the_phoenix_6"), ],
                [(display_message, "@Castle fortifications are completed !",0x259b6a ),
				  #----------outpost-----------
					(party_set_slot,"p_outpost", slot_castle_exterior, "scn_my_castle_exterior"),
				  (call_script, "script_succeed_quest", "qst_the_phoenix_6"),
					(call_script, "script_end_quest", "qst_the_phoenix_6"),
					(assign, "$g_player_fortress",2),
					#-----------------------------
                   ]),
	#----------------------------------------------	

  (24, 0, ti_once, [
					(neg|check_quest_active,"qst_lady_of_dirim_0"),
					(neg|check_quest_succeeded,"qst_lady_of_dirim_0"),
					
					(troop_slot_ge, "trp_kingdom_7_lord", slot_troop_prisoner_of_party, 0),
					
					(call_script, "script_search_troop_prisoner_of_party", "trp_kingdom_7_lord"),
					(assign, ":target_center", reg0),	            
					(is_between, ":target_center", walled_centers_begin, walled_centers_end), #Skip if she is not in a walled center
					(try_begin),
						(neg|check_quest_active,"qst_long_life_to_the_king"),
						(quest_set_slot, "qst_lady_of_dirim_0", slot_quest_target_troop,  "trp_kingdom_7_lord"),
						(quest_set_slot, "qst_lady_of_dirim_0", slot_quest_target_center, ":target_center"),
						(quest_set_slot,  "qst_lady_of_dirim_0", slot_quest_expiration_days, 30),
						(quest_set_slot,  "qst_lady_of_dirim_0", slot_quest_giver_troop, "trp_kingdom_7_lord"),
						
						(str_store_party_name_link, s9, ":target_center"),
						(str_store_troop_name, s10, "trp_kingdom_7_lord"),
						(str_store_string, s2, "str_try_to_free_s10_retained_captive_at_s9"),            
						(call_script, "script_start_quest", "qst_lady_of_dirim_0", "trp_player"),
					(try_end),
				],
                [
					(jump_to_menu, "mnu_empress_capture"),
                   ]),

#---------------------------Dusk Voyager anti-siege script ------------
# (0.01, 0, 0.01, [], [
...
# (eq, ":behavior", ai_bhvr_attack_party),
# (eq, ":object", "p_outpost"),
# (party_set_slot, "p_outpost", slot_center_is_besieged_by, -1),
# (party_set_ai_behavior, ":party_no", ai_bhvr_avoid_party),
# (party_set_ai_object, ":party_no", "p_outpost"),
# (party_set_slot, ":party_no", slot_party_ai_state, spai_undefined),
 # (try_begin),      
 # (party_slot_eq, "p_outpost", slot_village_state, svs_under_siege),        
 # (party_set_slot, "p_outpost", slot_village_state, svs_normal),
 # (party_set_extra_text, "p_outpost", "str_empty_string"),
 # (try_end),
# (try_end),
  # ]),
  #----------------------------------------------------

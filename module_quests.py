...
##  ),
 ...
 ("collect_debt", "Collect the Debt {s3} Owes to {s9}", qf_random_quest,
  "{!}{s9} asked you to collect the debt of {reg4} lobaris {s3} owes to him."
  ),
...
# Note : This is defined as the first mayor quest in module_constants.py: 
 ...
 ("kidnapped_girl", "Ransom Girl from Bandits", qf_random_quest,
  "{!}Guildmaster of {s4} gave you {reg12} lobaris to pay the ransom of a girl kidnapped by bandits.\
 ...
 ("persuade_lords_to_make_peace", "Make Sure Two Lords Do Not Object to Peace", qf_random_quest, #possibly deprecate., or change effects
  "{!}Guildmaster of {s4} promised you {reg12} lobaris if you can make sure that\
...
############
#----------Jalik  quest----------
	("renegade_mercenaries", "Renegade mercenaries", 0, "{!}Destroy the renegade mercenary party!"),
#--------------------------------  
#----------kingdom quest----------
	("the_phoenix", "The Phoenix", 0, "{!}Deliver prisoners from the Black Order guards"),
	("the_phoenix_2", "The Phoenix (part 2)", 0, "{!}Recruit 10 mercenaries"),
	("the_phoenix_3", "The Phoenix (part 3)", 0, "{!}20000 lobaris !"),
	("the_phoenix_4", "The Phoenix (part 4)", 0, "{!}In 40 days !"),
	("the_phoenix_5", "The Phoenix (part 5)", 0, "{!}Fortifications !"),
	("the_phoenix_6", "The Phoenix (part 6)", 0, "{!}In 40 Days again !"),
	("master_armorer", "Master Armourer", 0, "{!}Bring the necessary material to your armourer"),
#--------------------------------  
#----------kingdom quest----------
	#--Dirim
	("for_the_empire", "For The Empire", 0, "{!}Restaure Dirim Empire."),
	#("for_the_empire_part_2", "For The Empire", 0, "{!}Restaure Dirim Empire."),
	
	("lady_of_dirim_0", "The Lady of Dirim (Lady in Distress)", 0, "{!}Free the captive Empress"),
	("lady_of_dirim", "The Lady of Dirim (The last bodyguard)", 0, "{!}Meet Finjir at Dirim"),
	("lady_of_dirim_2", "The Lady of Dirim (A new hero)", 0, "{!}Find ways to help the Lady of Dirim"),
	("lady_of_dirim_3", "The Lady of Dirim (Long live to the Empress)", 0, "{!}Give Oath of Homage to the Empress"),
	
	("last_legion", "The Last legion - The hidden fort", 0, "{!}Search and rescue General Linkadas"),
	
	("last_legion_slaver", "The Last legion - The Slaver", 0, "{!}find slaver who bought the general"),
	("last_legion_gladiators", "The Last legion - The Gladiators", 0, "{!}Capture 4 warriors and deliver them to Ramun"),
	("last_legion_2", "The Last legion - The Prison", 0, "{!}Search and rescue General Linkadas"),
	("last_legion_3", "The Last legion - Return to Dirim", 0, "{!}Return to Dirim and meet the Empress"),
	
	#--Pravar
	("long_life_to_the_king", "Long life to the king - The mercenary", 0, "{!}You had a contract with Pravar to serve him as mercenary captain for a certain time."),
	("siege_of_dirim", "Siege of Dirim ", 0, "{!}Join the siege of Dirim  and  try to show your prowess in presence of Pravaran seigniory"),
	("knight_of_pravar_feast", "Knight of Pravar - The feast", 0, "{!}join the king's feast and try to meet him"),
	("long_life_to_the_king_knight", "Long life to the king - The knight", 0, "{!}You are now a knight of Pravar, you have now multiple possibilities to become more powerful and wealthy..."),
	("knight_of_pravar_defector", "Knight of Pravar - The Defector", 0, "{!}Find Duke Kaladus and try to persuade him to join Pravar"),
 #--------------------------------- 

...
#SOD Computica Changed: "Pistol Smoke"     
    ("pistol_smoke", psf_billboard_3d, "prtcl_dust_a",
     90, 4.5, 0.6, -0.001, 30.0, 1.5,     #num_particles, life, damping, gravity_strength, turbulance_size, turbulance_strength #SOD Computica: "life: 3.5 to 7"
     (0.0, 0.75), (1, 0),       #alpha keys
     (0.0, 0.7), (1, 0.2),      #red keys
     (0.0, 0.7), (1, 0.2),      #green keys
     (0.0, 0.7), (1, 0.2),      #blue keys
     (0, 1.5),   (0.5, 11.0),   #scale keys
     (0.1, 0.1, 0.1),           #emit box size
     (2, 2, 0),                 #emit velocity
     0.1                        #emit dir randomness
...
("blood_small", psf_billboard_3d | psf_randomize_size ,  "prt_mesh_blood_1",
    5000, 0.5, 6, 0.5, 0, 0,        #num_particles, life, damping, gravity_strength, turbulance_size, turbulance_strength
    (0.1, 1), (1, 0),          #alpha keys
    (0.1, 0.6), (1, 0.6),      #red keys
    (0.1, 0.5),(1, 0.5),       #green keys
   ...
   ("blood_medium", 0 ,  "prt_mesh_blood_1",
   5000, 0.3, 0,1, 0, 0,       #num_particles, life, damping, gravity_strength, turbulance_size, turbulance_strength
   (0.1, 1), (1, 0.0),        #alpha keys
   (0.1, 0.6), (1, 0.6),      #red keys
   (0.1, 0.5),(1, 0.5),       #green keys
   (0.1, 0.4), (1, 0.4),      #blue keys
   (0.0, 0.2),   (0.5, 1),      #scale keys
   (0.0, 0.0, 0.0),           #emit box size
   (0, 0.5, 0),              #emit velocity
   0,                         #emit dir randomness
   0,                         #rotation speed
   ...
   ("blood_large", psf_billboard_3d | psf_randomize_size ,  "prt_mesh_blood_3",
    500, 0.3, 1,0.0, 0, 0,        #num_particles, life, damping, gravity_strength, turbulance_size, turbulance_strength
    (0.1, 1), (1, 0.0),        #alpha keys
    (0.1, 0.6), (1, 0.6),      #red keys
    (0.1, 0.5),(1, 0.5),       #green keys
    (0.1, 0.4), (1, 0.4),      #blue keys
    (0.0, 0.4),   (3, 1.6),    #scale keys
    (0.0, 0.3, 0.0),           #emit box size
    (0, 1, 0),                 #emit velocity
    1,                         #emit dir randomness
    250,                       #rotation speed
...
#SOD Computica Added: "Musket Smoke"    
   ("musket_smoke", psf_billboard_3d, "prtcl_dust_a", #So that the musket smoke doesnt go down instead of forward
     400, 12.0, 0.6, -0.001, 60.0, 1.0,     #num_particles, life, damping, gravity_strength, turbulance_size, turbulance_strength
     (0.0, 0.75), (1, 0),       #alpha keys
     (0.0, 0.7), (1, 0.4),      #red keys
     (0.0, 0.7),(1, 0.4),       #green keys
     (0.0, 0.7), (1, 0.4),      #blue keys
...
#SOD Computica Added: "Musket Muzzle Fire Effects"
	("rifle_muzzle", psf_billboard_3d, "prt_mesh_fire_1",
		40, 0.500000, 0.700000, 0.000000, 5.000000, 0.500000, 
		(0.000000, 0.750000),   (1.000000, 0.000000),
		(0.000000, 0.232000),   (1.000000, 0.221000),
		(0.000000, 0.103000),   (1.000000, 0.171000),
		(0.000000, 0.026000),   (1.000000, 0.000000),
		(0.200000, 0.500000),   (0.000000, 0.200000),
		(0.000000, 0.100000, 0.100000),   
		(0.000000, 2.000000, 0.000000),   
		0.050000    
    ),	
#SOD Computica Added: "Pistol Muzzle Fire Effects"
	("pistol_muzzle", psf_billboard_3d, "prt_mesh_fire_1",
		25, 0.500000, 0.700000, 0.000000, 5.000000, 0.500000, 
		(0.000000, 0.750000),   (1.000000, 0.000000),
		(0.000000, 0.232000),   (1.000000, 0.221000),
		(0.000000, 0.103000),   (1.000000, 0.171000),
		(0.000000, 0.026000),   (1.000000, 0.000000),

...
#  ("black_guhulay_raiders","Black Guhulay Raiders",icon_guhulay_horseman_b|carries_goods(2),0,fac_black_guhulays,bandit_personality,[(trp_black_guhulay_guard,1,10),(trp_black_guhulay_horseman,5,5)]),
  ...
  ("village_farmers","Village Farmers",icon_peasant|pf_civilian,0,fac_innocents,merchant_personality,[(trp_farmer,5,10),(trp_peasant_woman,3,8)]),
	...
	("disciplined_patrol","Disciplined Party",icon_peasant,0,fac_disciplined,merchant_personality,[(trp_warrior_monk,1,5),(trp_flagellant,5,20),(trp_undisciplined,10,30)]),
	...
	("soens_of_mekhresh_army","Sons Of Mekhresh Army",icon_gray_knight,0,fac_sons_of_mekhresh,soldier_personality,[(trp_priest_of_mekhresh,1,1),(trp_disciple_of_mekhresh,1,20),(trp_acolyte_of_mekhresh,10,100),(trp_paysan,2,20,pmf_is_prisoner),(trp_common_prisoner,1,10,pmf_is_prisoner)]),

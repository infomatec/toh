...
# Ryan END
 ...
 When you wish to leave this or any other area or retreat from a battle, you can press the TAB key."),
  ...
  ("custom_battle_1", "{!}Lord Hermangild of Pravar is travelling with his household knights when he spots a group of raiders preparing to attack a small hamlet.\
 ...
 and spotting the new threat, they decide to combine their forces."),
  ("custom_battle_3", "{!}Lady Brina is leading the defense of her castle against a Pravar army.\
 Now, as the besiegers prepare for a final assault on the walls, she must make sure the attack does not succeed."),
  ("custom_battle_4", "{!}When the scouts inform Lord Gundobad of the presence of an enemy war band,\
...
# meet_spy_in_enemy_town quest secret sentences
  ...
  ("secret_sign_2",  "I am selling these fine Guhulay tapestries. Would you like to buy some?"),
...
# Surname
  ...
  ("surname_2",  "{s50} of Bulcush"),
  ("surname_3",  "{s50} of Nidgornia"),
  ("surname_4",  "{s50} of Kalisos"),
  ("surname_5",  "{s50} of Bilomadal"),
  ("surname_6",  "{s50} of Taresterina"),
  ("surname_7",  "{s50} of Gohmasda"),
  ("surname_8",  "{s50} of Tarahbo"),
  ("surname_9",  "{s50} of Burfell"),
  ("surname_10", "{s50} of Hernar"),
  ("surname_11", "{s50} of Zendar"),
  ("surname_12", "{s50} of Yaddala"),
  ("surname_13", "{s50} of Bulcush"),
...
# Retirement Texts: s7=village name; s8=castle name; s9=town name
 ...
 and you sit a throne in your own splendourous palace as one of the most powerful figures in Tohlobaria."),
...
#npc16 = klethi --> Antonius
  ...
  ("npc6_intro", "Hail friend, how goes it? I am Stavik."),
  ...
  ("npc11_intro", "Ah! Yes! You there! You've come to save me? Wonderful, please untie these bonds!"),
  ("npc12_intro", "Hail fellow warrior! This son of Afirid greets you!"),
  ("npc13_intro", "Yes? What do you want?"),
  ("npc14_intro", "{playername} has finally come to see Zhurina"),
  ("npc15_intro", "Here is, Sir,  you are now the lord of your own castle"),
  ("npc16_intro", "Hmm? What is it?"),

  ("npc1_intro_response_1", "Je suis venu justement pour vous liberer, General"),
  ...
  ("npc4_intro_response_1", "Whelp? You want your nose broken? It might improve your appearance."),
  ("npc5_intro_response_1", "You look like an old warrior. Whats your story?"),
  ("npc6_intro_response_1", "Hail. I'm {playername}, it goes well. You look like a trader, but you aren't with a caravan?"),
  ...
  ("npc11_intro_response_1", "Hold it there... I want you to explain why you're here. You certainly are no merchant's son."),
  ("npc12_intro_response_1", "Hail! I am (playername). Whats an Afirid soldier doing all the way out here?"),
  ("npc13_intro_response_1", "A soldier. I see that crossbow on your back. And your stare of a thousand yards."),
  ("npc14_intro_response_1", "How did you know my name? Yes, I have come to see you; but answer me first."),
  ("npc15_intro_response_1", "a fine work"),
  ("npc16_intro_response_1", "Hail, Dirimite. That's some mighty old armour you're wearing."),

  ("npc1_intro_response_2", "peut-etre dois-je effectivement vous laisser enfermé, vous me paraissez assez louche!"),
  ("npc2_intro_response_2", "Sorry, I have no time for that."),
  ("npc3_intro_response_2", "Run along now, girl. I have work to do."),
  ("npc4_intro_response_2", "I'm not going to bandy words with a drunken northerner'"),
  ("npc5_intro_response_2", "I didn't say anything old man."),
  ("npc6_intro_response_2", "I don't have time for small talk, bother someone else."),
  ...
  ("npc11_intro_response_2", "No, you're tied up for a reason. You can stay in those bonds, wretch."),
  ("npc12_intro_response_2", "Son of Afirid? I don't trust you desert folk. Begone!"),
  ("npc13_intro_response_2", "Nevermind, I just realized you are Wyu. I don't deal with invader scum."),
  ("npc14_intro_response_2", "A witch who already knows my name? No thanks."),
  ("npc15_intro_response_2", "Goodbye"),
  ("npc16_intro_response_2", "Bah, I have no time to waste talking to old soldiers..."),

#backstory intro
  ("npc1_backstory_a", "General ?! oui oui ... c'est moi , je suis giniral"),
  ("npc2_backstory_a", "It's a tragic tale, sir."),
  ("npc3_backstory_a", "A good question, and I shall tell you!"),
  ("npc4_backstory_a", "Haha! This arsehole gets it."),
  ...
  ("npc6_backstory_a", "Ah, me? Yes, you could say I am a trader of sorts. An adventurer would be more apt."),
  ...
  ("npc11_backstory_a", "I was captured by these brutes, and they tied me up here... isn't that reason enough to save me? No...? (The man sigh's)"),
  ("npc12_backstory_a", "Simply trying to find my fortune in this world sir."),
  ("npc13_backstory_a", "My stare of a thousand yards huh..."),
  ("npc14_backstory_a", "You seem startled? Zhurina listens to things around her. Your arrival here was not unknown, and if you think that then perhaps one should reconsider their perception and focus more."),
  ("npc15_backstory_a", "I'm an engineer, specialized in the art of fortification. If you need a wall knocked down, I can do that, given enough time. If you need a wall built back up, I can do that too, although it will take longer and cost you more."),
  ("npc16_backstory_a", "Indeed. This set of armour was originally my great grandfather's, and my grandfather, father's and now mine. It's been in my family for generations, a legacy of our service in and of itself."),

#backstory main body
  ("npc1_backstory_b", "alors maintenent pouvez-vous avoir la gentillesse de me liberez"),
  ("npc2_backstory_b", "A while back, I left Atia with a caravan of goods. I was hoping to sell it all in Burfell and make a hefty sum. But, what do you know... we were looted and captured by those who are supposed to protect us!"),
  ("npc3_backstory_b", "My father, a well-known merchant, decided that I should be married to one of his business partners, a man well past the age of 50. I have been an obedient daughter all of my life, but it was a ridiculous and horrid proposition. So I ran away!"),
  ("npc4_backstory_b", "I am Ymir, I kill weaklings and cowards.  I'd kill you right now but I'm a fair bit drunk, and I'd rather not spill more blood' the last time I did the owner got mad, refused me drink, and this is the last tavern I am allowed in so I'd rather not chance it."),
  ...
  ("npc6_backstory_b", "I left home and my father's blacksmith a few years back, and have been on the road since. I mostly peddle goods, and live the life on the road."),
  ...
  ("npc11_backstory_b", "Lets just say I borrowed some horses, and I was going to lend these men some but they instead stole my borrowed horses, and then tied me up."),
  ("npc12_backstory_b", "I have intentions of becoming more than just a soldier of fortune though... I dream of becoming a noble warrior- granted the rights of nobility through valour and service. While I do love my homeland, the princes and realm of the Afirid dynasty is one with much political contempt, and is hard for one to rise up in. So I am willing to travel abroad and grow a reputation as a powerful warrior."),
  ("npc13_backstory_b", "Yes. You could say im a soldier. Was a soldier."),
  ("npc14_backstory_b", "I am Zhurina, just a woman, with good eyes and ears to pay attention to the world around me with. Don't believe the tales people say, for they are blind and deaf to how things truly work. I am no witch, and while rumours may say my husband was killed by me; my poor old foolish love died for other reasons, reasons I would rather not talk about, if you don't mind."),
  ("npc15_backstory_b", "For you I'd do anything, I owe you freedom, even my life!"),
  ("npc16_backstory_b", "Order, duty and the honour that follows it, that's what matters I say. But it's a shame, I can't uphold my duty anymore, or at least that's what the authorities back in the Dirim army told me. Getting old and your knee injury is too problematic they said."),

#backstory recruit pitch
  ("npc1_backstory_c", "hein... pourquoi vous riez comme ça ?"),
  ...
  ("npc4_backstory_c", "But you, you I'd love to just sink my axe into. What brings you to this frigid piss hole?"),
  ...
  ("npc6_backstory_c", "And my travelling experience tells me you look like a captain of some sort."),
  ...
  ("npc11_backstory_c", "And needless to say, I've been stuck here, these bastards wanting to sell my head to some people who want to see me dead."),
  ("npc12_backstory_c", "You look like a commander. I'm sure you've seen some mighty fierce battles."),
  ("npc13_backstory_c", "I already know what you want. You want me to fight. Normally I'd say no, but now I am running low on money."),
  ("npc14_backstory_c", "This one's eyes can see you look for something. And my ears tell me you search for someone who is good at scouting..."),
  ("npc15_backstory_c", "in case of construct or demolish anything, I'm your man "),
  ("npc16_backstory_c", "I remember being in tow and line with all the boys, spear and shield in hand... holding out against the enemies of the empire- barbarian and traitor alike. In all honesty my old legate personally dismissed me as he didn't want to see one of the few lauded veterans of the old guard to die, I feel."),
...
### use these if there is a short period of time between the last meeting 
  ...
  ("npc6_backstory_later", "While travelling with caravans is alright, you don't really profit until you see the thrill of battle and adventure about as a soldier, I've heard."),
  ...
  ("npc12_backstory_later", "Perhaps I could join your company of soldiers and work under your banner? Even if its just for a little while?"),
  ("npc13_backstory_later", "You just better not be a foolish commander... I've had enough of those."),
  ("npc14_backstory_later", "I ask now' are you wanting these old eyes and ears to be your guide, or do you wish to remain blind in the dark, stumbling for the light? Zhurina can see what others cannot."),
  ...
  ("npc16_backstory_later", "I personally couldn't care less... I don't feel much complete anymore. Nothing to do sitting here on my arse, I yearn to be out on the fields again someday as a soldier proper."),


  ("npc1_backstory_response_1", "bon, assez rigole... vous etes qui et c'est quoi votre histoire... plus de mensonges sinon je vous laisse pourrir ici!"),
  ...
  ("npc4_backstory_response_1", "You have that right. I'm looking for some bloodthirsty bastards for my warband, and you fit the bill."),
  ("npc5_backstory_response_1", "You'll have your second chance warrior. I happen to lead a warband, and im looking for soldiers."),
  ("npc6_backstory_response_1", "You've heard right then. Me and my band definitely have our fair share of excitement. We could use a savvy trader in our party, why not join us?"),
  ...
  ("npc12_backstory_response_1", "Certainly. A young soldier with great ambitions is perfectly welcome in my party of fortune seekers!"),
  ("npc13_backstory_response_1", "Do not worry. I am tempered in my command, otherwise- I'd be dead already."),
  ("npc14_backstory_response_1", "Your sense of perception is truly remarkable. I'd be a fool to refuse."),
  ("npc15_backstory_response_1", "I might be able to use you in my company."),
  ("npc16_backstory_response_1", "A soldier is always a soldier in my opinion, bad knee or not. I could use you in my company."),

  ("npc1_backstory_response_2", "je vous libere sieur Jirinal ou qui que tu sois, mais deguerpis avant que je change d'avis!"),
  ...
  ("npc4_backstory_response_2", "You're disgusting. I have no time for filthy barbarians."),
  ("npc5_backstory_response_2", "You should retire, old man. The battlefield isn't the place for washed up bastards like you."),
  ("npc6_backstory_response_2", "A young runaway man seeking thrill? Good grief, go home already."),
  ...
  ("npc12_backstory_response_2", "I have no time for commonborn thugs trying to wedge their way into the life of the aristocracy..."),
  ("npc13_backstory_response_2", "Perhaps it's that blatant disrespect for superiors that you show is why Wyu was defeated. I have no time for deserters."),
  ("npc14_backstory_response_2", "A mystic is never a good idea in a party. You put me and my men on edge."),
  ("npc15_backstory_response_2", "Sorry. I've got all the men that I can manage right now."),
  ("npc16_backstory_response_2", "You should listen to your superior and just retire. A crippled soldier is a liability in the field."),

  ("npc1_signup", "{Sir/Madame} -- bon bon ne vous enervez pas... je m'appelle Charob, et je suis un chasseur, traqueur et je connais la Grande Foret comme ma poche, il y a quelque temps j'ai ete contacte par un noble qui voulait traverser le territoire incognito, parait-il pour une mission secrete ou quelque chose de ce genre. helas nous etions tombé dans un embuscade, tendu par ceux qui conrolait ce camps, un groupe de fanatiques je vous dis"),
  ("npc2_signup", "Well, I will confess that I am not a warrior by trade."),
  ("npc3_signup", "Do you? Well, I am in no position to be picky! I would be pleased to rejoin you again."),
  ("npc4_signup", "Haha! I knew it! This one is a killer, can't fool me."),
  ...
  ("npc6_signup", "I would be glad to join you!  Seems like it'd be a wonderful way to travel."),
  ...
  ("npc12_signup", "Most excellent sir. I will bravely fight for you."),
  ("npc13_signup", "Very well... I apologize if I seemed blunt. As you might understand, the Wyu armies were routed due to poor decisions from our higher command, and I am wary of such things."),
  ("npc14_signup", "I will guide you then, young warlord."),
  ("npc15_signup", "I would be pleased to join you."),
  ("npc16_signup", "Really? You'd offer an injured fool like me a place in your line?"),

  ("npc1_signup_2", "ah... c'est peut-etre lui que vous cherchez? votre Jirinal...il a été recament vendu a un esclavagiste "),
  ...
  ("npc4_signup_2", "But how much of a killer is the question.  I'm not going to travel with some milk drinking son of a whore who can't enjoy the finer prospects of war' and I certainly am not going to fight alongside a coward, or a better way of saying it is, I am not going to fight in a warband that is known for running away. Better to die like a man then leave your manhood behind in defeat."),
  ...
  ("npc6_signup_2", "Just don't expect me to go about killing simple folks, I am an adventurer, not some cut throat bandit. My own family were people of common birth and I stand by the motto of what goes around comes around. Otherwise, life on the road can be rough and I can understand that."),
  ...
  ("npc12_signup_2", "Though, I would like to mention that while I may be a soldier of fortune seeking to increase my own place in this world, I am not a compassionless monster. I will not slaughter the weak and the innocent in their homes, I am a warrior, not a brigand. I only fight those with the wealth and strength to afford their own protection."),
  ("npc13_signup_2", "I understand I am an outsider in these lands. I'm not hard to please, just keep me fed, paid and don't take me into completely hopeless battles, and we will be fine. I'm a proficient soldier even after these years. My eventual hope is to earn enough to just return home, I don't care how that money is achieved at this point either."),
  ("npc14_signup_2", "My bow and my eyes are under your command, but if one is to break their promises and solemn oaths, then I will no longer guide you. Serving a blind leader is how one is lost in a storm."),
  ("npc15_signup_2", "{!}."),
  ("npc16_signup_2", "It sounds too good to be true... but if you're serious, I accept, on condition that you are a proper army. I am not going to be killing civilians, seeing mistreatment of the men or lacking in proper food. I expect a proper army, not a band of brigands, do I make myself clear?"),
  ...
  ("npc6_signup_response_1", "Yes, of course. I'm a commander, not some reaver."),
  ...
  ("npc12_signup_response_1", "Understandable. Looting the peasants typically yields nothing but their blood and misery to begin with."),
  ("npc13_signup_response_1", "Of course, what sort of commander would I be if I didn't take care of my soldiers? You needn't worry."),
  ("npc14_signup_response_1", "I keep my promises, old woman. You need not fear that."),
  ("npc15_signup_response_1", "Good. I'll be happy to hire someone like you."),
  ("npc16_signup_response_1", "And a proper army is what you shall fight in."),

#11
  ("npc1_signup_response_2", "Allez vous etes libre, au revoir"),
  ...
  ("npc4_signup_response_2", "I'm not in the business of hiring complete psychopaths. I want soldiers, not barbarians."),
  ...
  ("npc6_signup_response_2", "You should just go home to your father then if you can't handle killing some yokels. I don't have time for weak stomached wretches."),
  ...
  ("npc13_signup_response_2", "Thinking on it again, I don't really want to pay my hard earned coin to a former invading scumbag. You can rot in these Tohlobarian streets for all I care."),
  ("npc14_signup_response_2", "Your demeanour and vagueness puts a queer and foul air about you hag. I'm not having a witch march in my army; I'll do without such nonsense."),
  ("npc15_signup_response_2", "Actually, I need a different kind of expertise. My apologies."),
  ("npc16_signup_response_2", "Maybe you aren't cut out for warfare anymore. I'll let you be the parade piece you are and drink your wine in peace."),
  ...
  ("npc16_payment_response", "Of course, get your gear in order and fall in line."),
  ...
  ("npc13_morality_speech", "Captain, if we can avoid it, I'd prefer not to {s21}. Tohlobaria is a small place, and one's reputation is precious. I would not care for one of my rivals to include this latest unfortunate incident in a satirical verse."),
  ...
  ("npc4_personalityclash_speech", "{Sir/Madame}. The House of Rolf is one of the most ancient and respected families in this part of the world, with a provenance dating back to the Old Tohlobarian Empire. Yet {s11} openly shows me disrespect, and casts doubt on the provenance of my house."),
...
### set off by behavior after victorious battle
  ...
  ("npc2_personalityclash2_speech_b", "The enemy was bearing down on us, and he says, 'Step aside, merchant, this is knight's work.' Next time I will step aside, and let him take a spear in the gut."), #rijat - alayen
  ...
  ("npc6_personalitymatch_speech", "Captain. Sometimes I am troubled by all this bloodshed, although I know that proud warlords must be humbled, and cruel bandits tamed, if we are to restore peace to Tohlobaria."),
  ...
  ("npc1_personalitymatch_speech_b", "Without good honest souls like him to bring silver into Tohlobaria, scoundrels like me would have a hard time in life, I'll warrant. I'm glad to have him with us."),
  ...
  ("npc8_personalitymatch_speech_b", "He managed to include their geneology, their appearance, and their eating habits in a well-framed Old Tohlobarian quatrain. I personally prefer the saga, but we Hadvogs respect poetic craftwork when we hear it."),
  ...
  ("npc12_personalitymatch_speech_b", "It saddens him deeply to take the lives of his fellow men, however just the cause. He and I have talked together of a brighter future, of the need to unite these petty warring kingdoms of Tohlobaria, so that we may bring this time of troubles to an end."),
  ("npc13_personalitymatch_speech_b", "Also, although I normally prefer the coy to the Amazonesque, I confess that I have also noticed the femininity she tries to hide beneath her martial demeanour. True, she is a bit aloof on the march and in camp, but perhaps my fair words can melt the Hadvog ice around her heart."),
  ...
  ("npc7_retirement_speech", "I am tired of this squalid life of endless warfare, seeing men debased by fear, greed, lust, and a hundred other sins. I have money in my purse. I am going overseas to look for a better land than Tohlobaria. I assume that you will fare well without me."),
  ("npc8_retirement_speech", "I have fought in your shield wall, and done well by it. But your leadership is not always to my liking, and anyways I have another task. I will take what plunder I have won and raise a warband of my own and sail to Hadvogland to take back my husband's hall from my treacherous brother-in-law. I wish you well."),
  ...
  ("npc10_retirement_speech", "I've had enough of tromping up and down the length and breadth of Tohlobaria. I've got enough to buy a small bit of land somewhere, so I think I'll give that a try. So long, and best of luck to you."),
  ...
  ("npc12_retirement_speech", "I've done all right in your company. I filled my belly, put some gold in my purse, and broadened my knowledge of wounds and injury -- I can't complain about that! But I think right now that service in this company is holding me back. I have a duty to share my findings with other surgeons, and for that I need to hire scribes, who are rare in Tohlobaria. I shall be going home"),
  ...
  ("npc7_rehire_speech", "Captain! It is good to see you. Forgive what I may have said when we parted. I took a ship out of Bulcush, bound for the east, but it was taken by pirates and after my ransom I was set ashore back here. There may be better places in the world than Tohlobaria, but I have yet to see them. So I think, if it is my lot to live here, then your company is as good a livelihood as any. Will you have me back?"),
  ("npc8_rehire_speech", "Greetings to you, {playername}. I was wondering if the harsh words spoken between us in the past could be forgotten. I have been hunting among the Hadvogs here, to see if I could find enough men to take back my husband's hall. But I could not find enough men to crew a longship, and those whom I gathered quickly got bored and wandered off -- not, I will add, before they drank away such gold as I had accumulated. So I thought back to the battles we fought together. Those were good days, and profitable ones too."),
  ...
  ("npc14_rehire_speech", "Captain. It is good to see you. When last we parted, I was ready to swear that I would not serve you again, but perhaps I judged you too harshly. All over Tohlobaria, men sing your praises. I have tried serving in other lords' armies, and believe me, what I have seen of them restores my opinion of your leadership. If you would have me in your company, I would fight for you again."),
...
#local color strings
  ("npc1_home_intro", "Boss -- did you know that I was born around here, in the high steppe? This is where I got my eye for horseflesh, because this is good land for horses, although a hard land for men. I suppose that's why the Guhulays like it."),
  ("npc2_home_intro", "We're approaching Burfell. That's where I was headed when the bandits got me."),
  ("npc3_home_intro", "Can you smell that? Lemon trees, apples and crocus flowers, it's the scent of Taresterina. I spent many a happy summer here when I was a girl, playing in the gardens of my mother's family while my father was away trading."),
  ("npc4_home_intro", "The Woods of Ehlerdah. Bah. This place is thick with bandits and outlaws."),
  ("npc5_home_intro", "Bahadur, we are nearing Gohmasda, largest town in the lower steppe. My mother's sister went here to marry a townsman and I thought to seek service with the lord here. That is when I ran into you."),
  ...
  ("npc9_home_intro", "Behold the Rock of Yaddala! The strongest fortress in Tohlobaria. My father was one of those who held the line here against the Hadvogs, when they first tried to push inland from the coast."),
  ("npc10_home_intro", "D'you smell that fresh air, Brother? This was my home, before I went abroad in search of coin. It's good to be up in the hills again. It's the smell of freedom. This is the cradle of Imifir liberty, here under Grunwalder Castle"),
  ...
  ("npc13_home_intro", "Ah, Castle Ergellon! Such a lovely spot, at the foot of the Imifir highlands. Such happy days I spent here, the summer before last."),
  ...
  ("npc1_home_description", "Well, Guhulays always lived here, even back in the old days, as the Emperor gave them gold and lands to keep out the other tribes. I'm told my grandfather was a Guhulay chieftain, although my mother didn't know him, any more than I knew my father. When my mother was a lass, the Guhulay started coming over the mountains in larger numbers, and now there's a Guhulay Khan in Khosot."),
  ("npc2_home_description", "People say that the Hadvogs are a bunch of bloodthirsty barbarians, but they have a good head for trade, if you ask me. They make the people up and down the coast grow flax, which they weave here into linen. It can't compete with Bilomadal silks and velvets as a luxury fabric, but it makes good summertime wear and you can use it for the sails of ships. More importantly, linen was one of the few goods that someone else in Tohlobaria wasn't already making."),
  ("npc3_home_description", "Taresterina has wet winters and hot summers, but the people here build great cisterns to water their crops. They grow grapes -- Taresterinan wine is famous, {sir/madame} -- and those who can afford it make walled gardens, where fruit trees grow in abundance, and we sit at night listening to music, or playing chess, or merely sniff the night air."),
  ("npc4_home_description", "Well, you see, the King of Pravar declared this to be his personal hunting preserve, and said he'd kill any man who as much as strung his bow here. So what happens? Some family goes hungry, and succumbs to the temptation to poach, and the king's sheriff comes along and strings him up and takes his land. His sons, rather than starve, go bandit. And so naturally anyone in the whole valley who feels the need to run away from a debt or a nagging wife or a vengeful noble comes up here to join them, living on wild pigs and berries and the purses of unwary travellers."),
  ("npc5_home_description", "Guhulays had always come here, to trade and raid, and in the last days of the Empire we began to settle. Just like the Borovods, Pravars, Imifirs, Hadvogs and the House of Afirid, we took the Emperor's coin to keep the other tribes at bay. But when the Great Horde attacked our homeland in my grandfather's day, we moved into this region in force. We pushed the Afirids back, and made their fortresses our own."),
  ("npc6_home_description", "Here in the Vale of Kalisos, our dialect and customs are closer than anywhere else in Tohlobaria to those of the old Tohlobarian Empire. We grow olives and wine, both crops brought to this land from overseas by the emperors, and also follow the old Tohlobarian ways. We keep our pledges and pay our debts."),
  ("npc7_home_description", "Before I was married off, and before I was taken by bandits, I lived here. I was born in a hovel and spent my childhood in the fields. Our landlords were Hadvog, but we never saw them, merely their cursed minions and overseers. My father, coward that he was, cringed before them."),
  ("npc8_home_description", "You haven't heard the story? When Gundig Hairy-Breeks came to Tohlobaria from Hadvogland, he planted his banner on the headland and said that it would remain there until he recaptured his 'inheritance.' His 'inheritance', he called it. Gundig believed the skalds who told him that the Emperor had bequeathed Tohlobaria to the Hadvogs, when in fact he just gave us a small strip of land along the coast, so that we would crew his galleys."),
  ("npc9_home_description", "The Hadvogs would sail up the river in their longships. The townsmen of the coast could have stopped them, but they were cowards then, as they are today, and paid them a yearly stipend, known as the Hadvoggeld, to be let in peace. But the Borovod king would not pay. My father decided to come over the mountains, to fight with the Borovod hosts. Three summers in a row they tried to take the Rock, and each time the Borovod lords held them back."),
  ("npc10_home_description", "In my father's day the Pravars would come calling, thinking to make us knuckle our foreheads and call them their overlords. But Grunwalder, an old veteran of the wars from the hills, showed us how to form a battleline with spear and crossbow that could break a Pravar charge. He fell in battle, but the people gave his name to the castle that was built here, where he fell, so that we would remember, and always stand firm against the horsemens' onslaught."),
  ("npc11_home_description", "I'm from Lankladel. You know the saying, {sir/madame} -- 'Barley grown in Lankladel is made into ale in Pravar, and we're all the better for it.' Not sure what that means, {sir/madame}, but it's true about the barley. And wheat, and oats. We grow more grain here in the Vale of Lankladel then all the rest of Tohlobaria put together, and our ale is the best, too. You can see it in the soil here -- rich and black, and smells of good harvests and full bellies."),
  ("npc12_home_description", "The lord over there in Almerra Castle had the dropsy, and had requested a doctor from Lankladel to treat him. Like a typical university-educated doctor, he went right to Galerian for a cure. Galerian commends sun-metal for dropsy. Now most of Galerian's writings were useless back in the days of the Tohlobarian emperors when they were first written down, and they're doubly worthless today, but sometimes he hits upon the right cure by chance: sun-metal does cure some kinds of dropsy in small doses. However, sun-metal in large doses is poison, something that the Galerian-worshippers never grasped."),
#  ("npc13_home_description", "I had come up here with a small Pravar force, but they were caught by the Imifirs in the woods and their horsemen cut down amid the trees. I fled and found shelter by the lake, in the arms of the comeliest cowherd you ever saw. She took me to a cave near the high pastures, and would bring me cheese and berries, and tell me the tale from the hills. They say the lake is a gateway to the underworld, and sometimes on the fringes you can the noxious fumes beneath bubbling up to the surface. Such rustics they are!"),
  ("npc13_home_description", "I had come up here with a small Pravar force, but they were caught by the Imifirs in the woods and their horsemen cut down amid the trees. I fled and found shelter up in the high valleys, in the arms of the comeliest cowherd you ever saw. She took me to a cave near the high pastures, and would bring me cheese and berries, and tell me the tales from the hills -- of playful goat-men who guide lost animals back to their flocks, or of ghostly huntsmen who ride the winds, chasing stormclouds. Such rustics they are!"),
  ("npc14_home_description", "I say 'trying' because in my opinion, Borovods don't take well to discipline. Finest archers you ever saw, and good riders too, but they have no stomach for fighting in ranks. Their skills serve them well enough against Guhulays and Hadvogs, particularly when they can hide behind walls, but Afirids can match them arrow for arrow, and I've seen Pravar knights cut through Borovods like a knife through butter. Now, a Imifir spear-wall is designed to stop a Pravar charge in its tracks, and usually does."),
  ("npc15_home_description", "Like most castles that last around here, it's got foundations that are old Imperial Tohlobarian. You can't see them any more with all the rebuilding, but the slabs are the size of a house. They must have been real sorcerors back in those days, because I don't see how they moved those things otherwise. Beautiful location, too -- Culmarr sits right in front of the pass leading out of Tohlobaria, which allows the lord to charge a pretty penny in tolls during the three months of the year that it's not snowed in."),
  ...
  ("npc6_home_description_2", "We men of Kalisos also never forget an insult, and avenge any wrong done unto us. Old-fashioned Tohlobarian honour, I dare say, has brought me to my current fallen state. But despite that, I am proud to be from this region. Our lord is a vassal of the Pravar king in Pravar, but as far as we are concerned he is just yet another barbarian chieftain, and we are the Empire's true heirs."),
  ...
  ("npc15_home_description_2", "And here's the funny thing -- when the Imifir lands first rebelled against the Empire, they all said they weren't going to have any noble lords ruling over them. You can guess how long that lasted. One Imifir hill chieftain sets himself up in Culmarr, calls himself 'Count', and the good burghers of Bilomadal and Taresterina have to lick his boots if they want to sell their wine and velvet outside Tohlobaria. And if you want to keep the counts under control, and the peasants providing the towns with food rather than selling to the highest bidder, then you need a King too, don't you? The Imifir lands are no different than anyone else, whatever guff they talk about 'ancient liberties' and 'freedom.'"),
  ("npc16_home_description_2", "Still, it was a thin living, and there were always too many mouths around to feed. The Borovod king and the Guhulay khan don't make life any easier for us, squeezing for tax money the villages they control, and raiding for plunder the villages they don't. Of course, I can't say I wouldn't do the same if I had a castle and an army all of my own. The mighty do whatever they can, and the humble do whatever they must."),
  ...
  ("npc5_home_recap", "I was born in the highlands on the other side of the mountains, past Khosot, but I have relatives in {s21}."),
  ...
  ("npc8_home_recap", "I was born overseas, in Hadvogland, and my husband's hall also was in Hadvogland."),
  ("npc9_home_recap", "I am from the Borovod homeland over the mountains, where the Borovod lords lived before the Emperor brought them in Tohlobaria."),
  ("npc10_home_recap", "Born and raised in Bilomadal, {Brother/Sister}, and I hope some day to buy land there. But I had a mind to see a bit of the world first, so I took my crossbow and went off to the wars."),
  ("npc11_home_recap", "I was born in the train of an army, and lived all my days in the train of an army. My folk are from Pravar, however, so I guess that's as much home to me as anywhere."),
  ...
  ("npc15_home_recap", "I'm from over the hills. But Tohlobaria is where the money is to be made, these days, if your trade is siegecraft."),
  ...
  ("npc2_honorific", "{sir/madame}"), #rijat
  ...
  ("npc15_honorific", "{sir/madame}"), #artimenner
  ("npc16_honorific", "captain"), #klethi

  ("npc1_kingsupport_1", "That's a great idea, Boss. All these kings and khans and landed nobles who rule now, with their prisons and gibbets and scaffolds, the whippings and brandings and hangings for any man who might be driven by the crying of his children to steal a loaf of bread, or maybe a horse -- Tohlobaria deserves something better."), #Borcha
  ("npc2_kingsupport_1", "Well, captain -- I'd support you. I think you'd give Tohlobaria the kind of enlightened rule which it has long needed."), #rijat
  ...
  ("npc9_kingsupport_1", "Very good, my lord. I'm a Borovod by blood, but Burelek never stood for me when I was cheated of my inheritance. So I don't owe him anything, and I say, 'Let the throne go to the most valiant!' Which would be you, {sir/my lady}."), #Alayen
  ...
  ("npc8_kingsupport_2", "I would -- on one condition. You'd be king in Pravar or Burfell or wherever you want to rule, but I'd rule my own hall. And if I had a dispute with any other of your thegns, be it over land, livestock, or blood, you'd let us settle it sword to sword, according to the old ways, and let the heavens decide who is in the right."), #matheld
  ("npc9_kingsupport_2", "I would, {sir/madame}, and others would too. But here's what I think -- you need to show the noble lords that you'll uphold their ancient rights. Right now, Tohlobaria's a mess -- the lord owns the land, except it's the king who owns the forest, but the city has the right to levy tax at its gates, and the commons can use the pastures on odd Tuesdays, except in Yaddala when it's Wednesday. Who can remember? So I say you make things simple, like it was in the old days -- first the {king/sovereign}, then the lords, then everyone else."), #Alayen
  ("npc10_kingsupport_2", "Certainly, {Brother/Sister}. But I'd ask that you consider a thought of mine. If you became {king/queen}, then I'd ask you open your court to the common folks, and not just to the lords and blue-bloods. I'd ask you to let it be known that should any man be judged and sentenced, that he have the right to appeal to you directly. Right now, the lords have the right -- I say every man in Tohlobaria should have it, too."), #Bunduk
  ("npc11_kingsupport_2", "Of course, I would! Let me see your hand, there... Aha! You've got the 'Mark of Kings.' That's what we call it in Pravar, anyway. I hear in Kalisos it's the 'Emperor's Line,' but they call everything differently, over there. Anyway, yours is very long -- I'd say that it means that you're meant to rule! It's your destiny! In fact, I think I can even recall a prophecy to that effect. Hmm, how did it go..."), #katrin
  ("npc12_kingsupport_2", "Of course, captain.  But if I have learned anything in my travels in this land, it is that Tohlobarians are sticklers for precedent. Everything must be done as it was done in the days of the old Empire -- even though not more than one in a hundred of them can read enough Old Tohlobarian to understand the chronicles! Taresterina merchants marry their daughters according to the 'imperial' rite. Yaddala cattle herders churn 'imperial' butter. And of course, every king must be crowned according to 'imperial' law."), #jeremus
  ...
  ("npc14_kingsupport_2", "I would indeed, sir. I think you can unite this land, and then we'll be able to raise an army such as Tohlobaria has not seen for many generations -- Pravar lances, Borovod archers, Imifir spears, Afirid swords, Hadvog axes, and Guhulay skirmishers, and take it over the mountains to subdue all the lands that the Tohlobarian emperors once held sway."), #lazalit
  ...
  ("npc2_kingsupport_2a", "Please continue..."), #rijat
  ...
  ("npc2_kingsupport_2b", "I do not ask for their support, as they would no doubt wish to make a profit on the transaction."), #rijat
  ...
  ("npc8_kingsupport_3", "Good! Then give me a few weeks and I'll go about the courts of this land, letting it be known that you're a {king/ruler} who respects the thegns and their ancient rights. You won't go sticking your royal nose where it doesn't belong, and Tohlobaria will be the better for it."), #matheld
...
#
  ...
  ("npc2_intel_mission", "{Sir/My lady}, if you're interested in events in {s18}, I can still make contact with my old trading partners in {s17}. They're usually well-informed about political events."), #rijat
  ...
  ("npc11_intel_mission", "{Laddie/Lassie} -- I was thinking that it's been a while since I visited my kinfolk in {s17}. They've been kind enough to me over the years, helping me out during the lean times, so I feel I'd like to share some of my newfound fortune with them. I've also bought wholesale enough times from the Pravar grain merchants for them to trust me. I'd reckon they might be persuaded to spill a few tidbits about events in the {s18}, if that would interest you."), #katrin
  ...
  ("npc15_intel_mission", "Captain. As you may know, I have for some time harbored a wish to go to {s17}, and study the masonry -- one of the finest examples of the old Tohlobarian style. As it happens, one of my colleagues is currently engaged there doing repair work on the curtain wall. While his sense of professional obligation I think would prevent him, rightfully, from disclosing to me any weaknesses in its defenses, I suspect that he would not be averse to offering up his opinion on the general state of the {s18}, if that is of interest to you."), #artimenner
  ...
  ("npc2_fief_acceptance", "{s17} as a fief? Well, I've always thought in terms of buying and selling goods, not in terms of governing anything. But now that you mention it, I bet I could make that place turn a fair bit of revenue. I thank you, {my Lord/my lady} -- this is a very kind turn that you have done me."), #rijat
  ...
  ("npc4_fief_acceptance", "Bahaha! A fief for Ymir? Are you drunk? Who cares, I will take this fief as my spoils, and I will enjoy my new thralls! I'll try and reserve the prettiest for you warlord, don't you worry!"), #rolf
  ...
  ("npc6_fief_acceptance", "You are most generous sire. I won't let this gift go to waste- the hum of industry and commerce will make this fief flow rich, and you in turn as well sir, you have my word."), #firentis
  ...
  ("npc11_fief_acceptance", "A fief for Makkara? How generous sire! I'll be sure to run this fief with great responsibility and care, don't you worry!"), #katrin
  ("npc12_fief_acceptance", "Sire, you have bestowed the greatest honour I could've ever asked for! You have made my dreams come true! I am no longer just of common blood... I have earned my rights to noble title! My lord, I will honour your gift with the utmost loyalty. I will ensure there will be able bodied and well trained subjects in this fief, you have my promise!"), #jeremus
  ("npc13_fief_acceptance", "I am baffled lordship, on my feelings about this title. My homesickness is great... even after all these years. But now I am conflicted as I now have a home here, a land and title beyond anything I could claim to back in my old homeland. You've provided more for me than my own blood has even sire, and this makes me feel confused. Regardless I shall serve faithfully and return your amnesty in full, commander."), #nizar
  ("npc14_fief_acceptance", "With all my powers of observation, not even I could predict this. You are generous, warlord, but I fear that I am too old to accept such a responsibility' I will steward this fief until I can contact my daughter, and perhaps she could take over with your permission."), #lazalit
  ...
  ("npc16_fief_acceptance", "A true reward for this old dog! Thank you sire, you may not be a true Tohlobarian emperor, but I am content knowing you are a ruler it very well needs. This fief is a great honour, an honour I will uphold proudly!"), #klethi  
  
  ("npc1_woman_to_woman", "{!}."), #Borcha
  ("npc2_woman_to_woman", "{!}."), #rijat
  ...
  ("npc2_turn_against", "This is a sad day. I never thought that I might meet my old captain on the field of battle. Even if I triumph, it will bring me no joy."), #rijat
  ...
  ("npc4_turn_against", "I will drink from your skull!"), #rolf
  ...
  ("npc6_turn_against", "This is just unfortunate. I have no words."), #firentis
  ...
  ("npc12_turn_against", "And so to my gift of nobility has come with its great responsibilities... I find myself at war with you my lord. Ready your troops, you will receive a battle worth praise in songs!"), #jeremus
  ("npc13_turn_against", "It has come to this... I am sorry sire. Please forgive me, but I have no other choice but to fight you."), #nizar
  ("npc14_turn_against", "This path was walked upon, when it shouldn't have been. I foresee death, whose, I do not know. If it is yours, wish it to be fast!"), #lazalit
  ...
  ("npc16_turn_against", "I can't keep serving you knowing you are going to disrupt stability and order. I must do my duty. Prepare to die."), #klethi
...
("comment_intro_liege_affiliated", "I am told that you are pledged to one of the pretenders who disputes my claim to the crown of Tohlobaria. But we may still talk."),
...
("comment_intro_noble_upstanding", "I see that you carry a nobleman's banner, but I do not recognize the device. No doubt you have come to Tohlobaria in search of wealth and glory. If this indeed is the case, then I only ask that you show mercy to those poor souls caught in the path of war."),
...
("comment_intro_female_noble_pitiless", "I see that you carry a noble's banner, but I do not recognize the device... You should know, lady, that in Tohlobaria it is the men to ride to war, and if you seek to overturn the natural order of things, you will find your fair head stuck on a pike -- like that of any other rebel!"),
("comment_intro_female_noble_cunning", "It is not unheard-of for a woman to seek her fortune on the battlefields of Tohlobaria, but neither is it usual. I shall be most interested in your progress."),
...
("comment_intro_female_common_cunning", "It is not unheard-of for a woman to seek her fortune on the battlefields of Tohlobaria, but neither is it usual. I shall be most interested in your progress."),
...
("rejoinder_intro_female_noble_sadistic", "Never mind my country. Here in Tohlobaria, it seems, dogs lead men to war."),
...
#steve post 0912 changes begin
  ...
  ("pravar_rebellion_pretender_intro",    "I am Isolla, rightful Queen of the Pravars."),
  ("borovod_rebellion_pretender_intro",     "My name is Valdym. Some men call me 'the Bastard.' I am a prince of the Borovods, but by all rights I should be their king, instead of my cousin Burelek."),
  ("guhulay_rebellion_pretender_intro",    "I am Dustum Khan, son of Janakir Khan, and rightful Khan of the Guhulays."),
  ("hadvog_rebellion_pretender_intro",       "I am Lethwin Far-Seeker, son of Hakrim the Old, who should be king of the Hadvogs of Tohlobaria."),
  ("imifir_rebellion_pretender_intro",     "I am Lord Kastor, the rightful King of the Imifirs, who will free them from tyranny."),
  ("afirid_rebellion_pretender_intro", "I am Arwa, whom they call the Pearled One, Mother of the Afirids and their rightful Queen."),

  
  
  ("pravar_rebellion_pretender_story_1",  "I was the only child of my father, King Esterich. Although I am a woman, he loved me like a son and named me his heir -- not once, but several times, before the grandest nobles of the land so that none could doubt his intention. There is no law that bars a woman from ruling -- indeed, we Pravars tell tales of warrior queens who ruled us in our distant past."),
  ("borovod_rebellion_pretender_story_1",   "My father died when I was young, leaving me in the care of his brother, the regent Burelek. But rather than hold the throne until I came of age, this usurper used his newfound power to accuse my mother of adultery, and to claim that I was not my father's son. She was executed for treason, and I was declared a bastard."),
  ("guhulay_rebellion_pretender_story_1",  "Janakir Khan and I are brothers, sons of the old Janakir Khan, although of different mothers. Although I was the younger brother, all those who knew the old Khan will testify that throughout my father's life, I was his favorite, entrusted with the responsibilities of government. Janakir busied himself with hunts and feasts to win the affection of the more dissolate of my father's commanders."),
  ("hadvog_rebellion_pretender_story_1",     "I am called the Far-Seeker because I have travelled great distances, even by the standards of the Hadvogs, in search of knowledge. Before I came of age, my father sent me abroad on a tour of study at the courts and universities in the lands overseas. If the Hadvogs are to call themselves the heirs of the Tohlobarian empire, then they must act the part, and know something of law and letters, and not call themselves content merely to fight, plunder, and drink."),
  ("imifir_rebellion_pretender_story_1",   "The Imifirs are a free people, and not slaves to any hereditary monarch. The king must be chosen from one of the leading noble families of the land, by a council drawn by lot from the patricians of the cities of Bilomadal, Taresterina, and Darenbay. The council meets on a field before Bilomadal, and no man is allowed to appear in arms during their deliberations, on pain of death."),
 ("afirid_rebellion_pretender_story_1", "I was born in a faraway land, to a humble family, and made a slave when I was but a girl -- but there is no shame in that, for the mothers of many of our kings were slaves. The old Sultan, Ayzar, spotted me in the markets and was struck by my beauty. I entered his household, and there he also learned to respect my intelligence. As he grew older, he allowed me to govern in his stead. First I managed the affairs of the palace, and later those of the realm."),

  ("pravar_rebellion_pretender_story_2",  "Yet when my father died, his cousin Wigberht convinced the nobles that no Pravar king of sound mind could name a woman as his heir. Wigberht said that his designation of me was the act of a madman, and thus had no legal standing, and that he, as my father's closest male relative, should of take the throne."),
  ("borovod_rebellion_pretender_story_2",   "I was smuggled abroad by a faithful servant, but now I am of age and have returned to reclaim what is rightfully mine. Burelek died soon after his act of perfidy -- the judgment of heaven, no doubt. His son Burelek now calls himself king, but as his claim is tainted, he is no less a usurper than his father, and I will topple him from his throne."),
  ("guhulay_rebellion_pretender_story_2",  "According to Guhulay custom, when a man dies his herds are split between all his sons, equally. So too it is with the khanate. When I heard of my father's death, I was away inspecting our borders, but I hurried home to Khosot, ready to give Janakir his due and share the khanate with him. But when I arrived, I found that he rushed his supporters to the court, to have himself proclaimed as the sole khan."),
  ("hadvog_rebellion_pretender_story_2",     "My father died however before I completed my course of study, and as I hurried home to claim his throne my ship was wrecked by a storm. One of my father's thanes, Viskhard, seized this opportunity and spread rumors that I had died abroad. He summoned a gathering of his supporters to have himself proclaimed king, and has taken the past few years to consolidate his power."),
  ("imifir_rebellion_pretender_story_2",   "During the last selection, there were but two candidates, myself, and Lord Montagu. While the council was deliberating, Montagu appeared, sword in hand, telling them that a Pravar raiding party was about to descend on the field of deliberation -- which was true, by the way -- and if he were not elected king, then he would leave them to their fate."),
 ("afirid_rebellion_pretender_story_2", "When Sultan Ayzar died, it seemed to the emirs of the realm only natural that I should succeed him as ruler, thus avoiding any danger of civil war. They insisted, however, that I should marry one of his generals, the Emir Baybak. The emirs then lined up to give us the oath of allegiance together -- to Baybak as Commander of the Armies, and to me as Mother of the Realm. For the brief time that we ruled, our realm prospered."),

  ("pravar_rebellion_pretender_story_3",  "I will admit that I did my cause no good by cursing Wigberht and all who listened to him as traitors, but I also believe that the magistrates who ruled in his favor were bought. No matter -- I will raise an army of loyal subjects, who would honour their old king's memory and will. And if anyone doubts that a woman can wield power, then I will prove them wrong by taking Wigberht' ill-gotten crown away from him."),
  ("borovod_rebellion_pretender_story_3",   "Until I have my rights restored in the sight of all the Borovods, I will bear the sobriquet, 'the Bastard', to remind me of what I must do."),
  ("guhulay_rebellion_pretender_story_3",  "My brother thinks that Guhulays will only respect strength: a leader who takes what he wants, when he wants it. But I think that he misreads the spirit of our people.--we admire a resolute leader, but even more we a just one, and we know that a man who does not respect his own brother's rights will not respect the rights of his followers."),
  ("hadvog_rebellion_pretender_story_3",     "So I remain in exile -- except now I am not looking for sages to tutor me in the wisdom of faraway lands, but warriors, to come with me back to the land of the Hadvogs and regain my throne. If Viskhard doubts my ability to rule, then let him say so face to face, as we stare at each other over the rims of our shields. For a warrior can be a scholar, and a scholar a warrior, and to my mind, only one who combines the two is fit to be king!"),
  ("imifir_rebellion_pretender_story_3",   "Well, Montagu defeated the Pravars, and for that, as a Imifir, I am grateful. When I am king, I will myself place the wreath of victory on his head. But after that I will have it separated from his shoulders, for by his actions he has shown himself a traitor to the Imifir confederacy and its sacred custom."),
  ("afirid_rebellion_pretender_story_3", "But alas, Baybak himself was soon killed in a skirmish with the Guhulays. Had I known of his death in time, I would have been able to prepare myself against any possibility of betrayal. But alas, my husband's treacherous nephew Ayzar came riding with his men, still covered with the dust of the battlefield, and drove me from the palace at swordpoint and proclaimed himself sultan. So be it -- I shall gather an army of my own, and return him the favor."),

  ("pravar_rebellion_monarch_response_1", "Isolla thinks she should be Queen of the Pravars? Well, King Esterich had a kind heart, and doted on his daughter, but a good-hearted king who doesn't use his head can be a curse to his people. Isolla may tell you stories of warrior queens of old, but you might also recall that all the old legends end in the same way -- with the Pravars crushed underfoot by the armies of the Tohlobarian Emperor."),
  ("borovod_rebellion_monarch_response_1",  "Were Valdym to come to me in peace, I would laden him with titles and honours, and he would become the greatest of my vassals. But as he comes in war, I will drag him before me in chains and make him acknowledge me as rightful sovereign, then cut his tongue from his mouth so that he cannot recant."),
  ("guhulay_rebellion_monarch_response_1", "My brother Dustum has perhaps told you of his insistence upon splitting the khanate, as though it were a herd of sheep. Let me tell you something. Ever since the Guhulays established themselves on this land, the death of every khan has had the same result -- the land was divided, the khan's sons went to war, and the strongest took it all anyway. I simply had the foresight to stave off the civil war in advance."),
  ("hadvog_rebellion_monarch_response_1",    "Lethwin 'Far-Seeker'? Lethwin Inkfingers, is more like it. Perhaps you have heard the expression, 'Unhappy is the land whose king is a child.' Unhappy too is the land whose king is a student. You want the Hadvogs to be ruled by a beardless youth, whose hand bears no callouses left by a sword's grip, who has never stood in a shield wall? If Lethwin were king, his thanes would laugh at him to his face!"),
  ("imifir_rebellion_monarch_response_1",  "No doubt Lord Kastor told you that I defiled the hallowed Imifir custom by interfering with the patricians' election of a king. Well, let me tell you something. The patricians of the towns make longwinded speeches about our ancient liberties, but then choose as their king whichever noble last sat in their villa and sipped a fine wine and promised to overlook their unpaid taxes."),
  ("afirid_rebellion_monarch_response_1", "Our scholars have long agreed that there is one overriding principle in politics. Men should accept the authority of the ruler, because tyranny is better than civil war. It was for that reason that I accepted the authority of both Baybak and Arwa, to whom I gave my oath as co-rulers."),

  ("pravar_rebellion_monarch_response_2", "Those who weep for the plight of a Pravar princess denied her father's throne should reflect instead on the fate of a Pravar herdswoman seized by a Borovod raider and taken as chattel to the slave markets. Talk to me of queens and old stories when our warlike neighbors are vanquished, and our land is at peace."),
  ("borovod_rebellion_monarch_response_2",  "Whatever my father may or may not have done to secure the throne does not matter. I have inherited it, and that is final. If every old claim were to be brought up anew, if every man's inheritance could be called into question at any time, then it would be the end of the institution of kingship, and we would live in a state of constant civil war."),
  ("guhulay_rebellion_monarch_response_2", "Dustum would make a fine assessor of flocks, or adjudicator of land disputes. But can you imagine such a man as khan? We would be run off of our land in no time by our neighbors, and return to our old days of starving and freezing on the steppe."),
  ("hadvog_rebellion_monarch_response_2",    "Old Hakrim may have had fancy ideas about how to dispose of his kingdom, but it is not just royal blood that makes a King of the Hadvogs. I am king by acclamation of the thanes, and by right of being the strongest. That counts for more than blood, and woe to any man in this land who says otherwise."),
  ("imifir_rebellion_monarch_response_2",  "The only liberty that concerns them is their liberty to grow fat. Meanwhile, my men sleep out on the steppe, and eat dry bread and salt fish, and scan the horizon for burning villages, and shed our blood to keep the caravan routes open. Here's an idea -- if I ever meet a merchant who limps from a Guhulay arrow-wound or a Pravar sword-stroke, then I'll say, 'Here's a man whose counsel is worth taking.'"),
  ("afirid_rebellion_monarch_response_2", "You should know, however, that Arwa was not chosen as Baybak's partner because of her wisdom or love of justice. No, she was chosen because she was a witch, who could transform men like Ayzar and Baybak into stammering fools. No matter -- I was true to my oath, and respected her usurpation, until the very hour that it was invalidated by the death of her puppet. Now she must respect mine."),
...
#courtship
  ...
  ("kingdom_1_adjective",                     "Pravar"),
  ("kingdom_2_adjective",                     "Borovod"),
  ("kingdom_3_adjective",                     "Guhulay"),
  ("kingdom_4_adjective",                     "Hadvog"),
  ("kingdom_5_adjective",                     "Imifir"),
  ("kingdom_6_adjective",                     "Afirid"),
...
^^VP Sales & Marketing EU:^Martin Sirc^^Distribution Manager Hadvog:^Erik Helmfridsson^^Director of PR & Marketing:^Susana Meza\
...
#multiplayer game type names
  ...
  ("you_speak_of_unifying_calradia_well_i_believe_that_well_always_be_fighting__its_important_that_we_fight_for_a_rightful_cause", "You speak of unifying Tohlobaria. Well, I believe that we'll always be fighting - it's important that we fight for a rightful cause."),
  ...
  ("you_speak_of_unifying_calradia_well_youve_done_a_good_job_at_making_calradia_bend_its_knee_to_you_so_maybe_thats_not_just_talk", "You speak of unifying Tohlobaria. Well, you've done a good job at making Tohlobaria bend its knee to you, so maybe that's not just talk."),
  ("you_speak_of_unifying_calradia_id_be_impressed_if_i_thought_you_could_do_it_but_unfortunately_you_dont", "You speak of unifying Tohlobaria. I'd be impressed if I thought you could do it. But unfortunately, you don't."),
  ...
  ("you_speak_of_unifying_calradia_well_much_of_this_land_now_bends_its_knee_to_you_so_perhaps_that_is_not_just_talk", "You speak of unifying Tohlobaria. Well, much of this land now bends its knee to you, so perhaps that is not just talk."),
  ("you_speak_of_unifying_calradia_but_right_now_yours_is_just_one_squabbling_faction_among_many", "You speak of unifying Tohlobaria, but right now yours is just one squabbling faction among many."),
  ...
  ("you_speak_of_unifying_calradia_well_many_have_said_that_you_might_very_well_be_the_one_to_do_it", "You speak of unifying Tohlobaria. Well, many have said that, you might very well be the one to do it."),
  ("you_speak_of_unifying_calradia_well_all_the_kings_say_that_im_not_sure_that_you_will_succeed_while_they_fail", "You speak of unifying Tohlobaria. Well, all the kings say that. I'm not sure that you will succeed while they fail."),
  ...
  ("you_speak_of_unifying_calradia_you_may_indeed_humble_the_other_kings_of_this_land_and_in_that_case_i_would_hope_that_you_would_remember_me_as_your_faithful_servant", "You speak of unifying Tohlobaria. You may indeed humble the other kings of this land, and in that case I would hope that you would remember me as your faithful servant."),
  ("you_speak_of_unifying_calradia_but_you_are_weak_and_i_think_that_you_will_remain_weak", "You speak of unifying Tohlobaria. But you are weak, and I think that you will remain weak."),
  ...
  ("you_speak_of_unifying_calradia_well_maybe_you_can_unite_this_land_by_the_sword_but_im_not_sure_that_this_will_make_you_a_good_ruler", "You speak of unifying Tohlobaria. Well, maybe you can unite this land by the sword. But I'm not sure that this will make you a good ruler."),
  ...
  ("you_speak_of_unifying_calradia_it_would_be_good_to_bring_peace_to_the_realm_and_i_believe_that_you_are_strong_enough_to_do_so", "You speak of unifying Tohlobaria. It would be good to bring peace to the realm, and I believe that you are strong enough to do so."),
  ("you_speak_of_unifying_calradia_it_would_be_good_to_bring_peace_the_realm_but_with_your_kingdom_in_its_current_state_i_worry_that_you_are_just_bringing_more_discord", "You speak of unifying Tohlobaria. It would be good to bring peace the realm, but with your kingdom in its current state, I worry that you are just bringing more discord."),
  ("s15", "{!}{s15"),
  ...
  ("noble", "noble"),
  ("common", "common"),
  ("may_find_that_you_are_able_to_take_your_place_among_calradias_great_lords_relatively_quickly", "may find that you are able to take your place among Tohlobaria's great lords relatively quickly"),
  ("may_face_some_difficulties_establishing_yourself_as_an_equal_among_calradias_great_lords", "may face some difficulties establishing yourself as an equal among Tohlobaria's great lords"),
  ("may_face_great_difficulties_establishing_yourself_as_an_equal_among_calradias_great_lords", "may face great difficulties establishing yourself as an equal among Tohlobaria's great lords"),
  ...
  ("current_party_morale_is_reg5_current_party_morale_modifiers_are__base_morale__50_party_size_s2reg1_leadership_s3reg2_elite_troops_s10reg10_food_variety_s4reg3s5s6_recent_events_s7reg4_total__reg5___", "Current party morale is {reg5}.^Current party morale modifiers are:^^Base morale:  +{reg6}^Party size: {s2}{reg1}^Leadership: {s3}{reg2}^Presence of elite troops: {s10}{reg10}^Food variety: {s4}{reg3}{s5}{s6}^Recent events: {s7}{reg4}^TOTAL:  {reg5}^^^"),
  ...
  ("outside_calradia", "outside Tohlobaria."),
  ...
  ("that_you_are_the_rightful_heir_to_the_throne_of_calradia", "That you are the rightful heir to the throne of Tohlobaria?"),
  ("that_s14_is_the_rightful_ruler_of_calradia", "That {s14} is the rightful ruler of Tohlobaria?"),
  ...
  ("khan", "khan"),
  ("i", "I"),
  ("according_to_the_ancient_law_and_custom_of_the_calradians_s45_should_be_s47", "According to the ancient law and custom of the Tohlobarians, {s45} should be {s47}"),
  ...
  ("you_plan_to_marry_s4_as_you_have_no_family_in_calradia_he_will_organize_the_wedding_feast", "You plan to marry {s4}. As you have no family in Tohlobaria, he will organize the wedding feast."),
  ...
  ("you_will_not_be_disappointed_sirmadam_you_will_not_find_better_warriors_in_all_calradia", "You will not be disappointed {sir/madam}. You will not find better warriors in all Tohlobaria."),
...
#STRINGS ADDED AFTER THE FREEZE
  ...
  ("faction_title_male_7", "Prefect {s0}"),
  ("faction_title_male_8", "Captain {s0}"),
  ...
  ("faction_title_female_5", "Matrician {s0}"),
  ("faction_title_female_6", "Lalla {s0}"),
  ("faction_title_female_7", "Prefete {s0}"),
  ("faction_title_female_8", "Captain {s0}"),
  ...
  ("lord_indicted_dialog_rejected",    "Indeed? Well, perhaps your reputation is misleading. Good day, {my lord/my lady} -- I go to see if another ruler in Tohlobaria is more appreciative of my talents."),
  ...
  ("quick_battle_troop_8", "Growing up with one of the nomadic tribes deep in the desert beyond Afirid lands, Gamara learned early on how to hunt with sling and spear. However, the simple life and pitiless conditions in the desert did not satisfy her, and she burned with a desire to see the great world beyond that she had heard so many wondrous tales about. Life is not easy for an adventuring young woman, and Gamara had to learn the ways of Tohlobaria quickly. Taking the weapons and armor of a soldier who had attacked her after a dispute, Gamara now hides her beauty under thick Afirid garb, and many never even suspect she is a woman �- certainly as a force on the battlefield she is as dangerous as any man. She has gathered about her a group of followers, and together they wander the war-torn land in search of glory."),
  ("quick_battle_troop_9", "Aethrod is not a noble person. He's changed his name twice, and is blamed for most of the crimes on Borovod territory. True or not, he claims to never have taken an innocent man's life, and considers himself a patriotic citizen, several times bringing his band or renegades to the assistance of his faction, when it is threatened. In times of peace, however, most lords must be careful when he is in the vicinity due to his daring personality and willingness to challenge a lord. Born and rasied in the slums of Nidgornia, he learned how to use a bow at an early age and ran away from home a fourteen. Now at thirty two, his archery skills are near perfect and though he can't ride a horse well, he can hit one at the furthest of distances. Tough as nails and sharp as a hawk, he is a true local legend."),
  ("quick_battle_troop_10", "Being the daughter of one of the most infamous bandit leaders in the Afirid realm isn't always easy, but Zaira seems to have managed quite well. Unlike most women she grew up learning the ways of the desert warrior and is deadly with the sword as well as the bow. While the other girls her age learned how to manage the household, Zaira learned how to best gut a merchant before taking his money. At the age of sixteen Zaira had killed more men than the average veteran in the Sultan's army. Just before her twentieth brithday her father was killed in brawl with another bandit leader. As the only child, Zaira now took control of her father's band. After avenging her father, she quickly picked up where he had left. Now she's on a good way of establishing her own reputation has a bandit leader."),
  ("quick_battle_troop_11", "Argo Sendnar had quite a diversified life. When he arrived at Tohlobaria, working as a trader, he hoped for more income than in Lokti. Little did he know, that the wartorn Tohlobaria was a wasps' nest for bandits and cutthroats that made trading a lot more complicated than in Lokti. Being bought out by another competeting trader, after losing all his goods and money due to caravan raids, he was forced to serve as a caravan guard to make a living. Despite his pathetic fighting skills, he soon found an employment on one of the more dangerous routes through Tohlobaria. Due to sheer luck he managed to stay alive long enough to aquire enough combat experience and money to start his own buisness as a caravan master, offering his services to traders in need of defense for their goods."),
  ...
  ("comment_intro_liege_affiliated_to_player", "I am told that you would dispute my claim to the crown of Tohlobaria. Needless to say, I am not pleased by this news. However, we may still talk."),
 ...
 ("journey_to_nidgornia", "You have come through the Borovod highlands, a plateau exposed to the bitter winds from the north. The land here is frozen for most of the year, but the forests are rich with fur-bearing game, and the rivers are teaming with fish. The riches of the land draw the traders, but the traders in turn draw bandits. You saw the occasional dark figure mounted on a shaggy pony, watching the passage of your caravan from a snowy ridge, and were glad when the spires of Nidgornia came into view across the wide valley of the Boluk river."),

 ("journey_to_pravar", "You came by caravan through the heartland of Tohlobaria. Green shoots of wheat, barley and oats are beginning to push through the dark soil of the rolling hills, and on the lower slopes of the snowcapped mountains, herds of cattle and sheep are grazing on the spring grass. Occasionally, too, you catch sight of one of the great warhorses that are the pride of the Pravar nobility. The land here is rich -- but also troubled, as the occasional burnt-out farm bears witness. You keep a wide berth of the forests, where desperate men have taken refuge, and it is some relief when you crest a ridge and catch sight of the great port of Pravar, its rooftops made golden by the last rays of the setting sun."),

  ("journey_to_jelkala", "You came by ship, skirting the cliffs where the Imifir highlands meet the sea. Much of the coastline was obscured by tendrils of fog that snaked down the river valleys, but occasionally you caught sight of a castle watchtower rising above the mists -- and on one occasion, a beacon fire burning to warn of an enemy warband. You knew that you were relatively safe at sea, as you were too far south to risk encountering the sea raiders who trouble the coasts of the Hadvog lands, but it was still a relief to reach the Selver estuary, gateway to the port of Bilomadal, and see a Imifir galley riding at anchor, its pennants fluttering in the evening breeze."),

  ("journey_to_burfell", "You took passage with a trading longship, carrying gyrfalcons from the furthest reaches of the north to be bartered for linen and wool. It sailed early in the season, but the master reckoned that the risks of drifting ice and later winter storms could be justified by arriving ahead of the Sea Raiders, who by April would be sailing forth from their island lairs to ravage Tohlobaria's coasts. It was some relief when your ship came in sight of the delta of the Vyl and Boluk rivers, and a short while later, rowed past tidal flats and coastal marshes to the city of Burfell, home to the Sea Raiders' distant kinsmen, the Hadvog lords, who a few generations ago had carved themselves a kingdom in this rich but troubled land."),

  ("journey_to_khosot", "You came with a caravan, crossing the mountains that border Tohlobaria on the north and east, bringing spices from faraway lands to trade for wool and salt. The passes were still choked with snow, and it was hard going, but at last you crested a ridge and saw before you the Tohlobarian steppes. On some hillsides the thin grass of spring was already turning yellow, but the lower slopes of the mountains were still a vibrant green. Herds of sheep and tawny steppe ponies drifted across them like clouds, testifying to the wealth of the Guhulay khans. From time to time small groups of horsemen would follow your caravan from a distance, perhaps sizing up how well you could defend the wealth you carried, so it was with some relief that you saw the towers of Khosot rising up from the plains."),


  ("journey_to_jabba", "You came with a caravan, crossing the great desert to the east of Tohlobaria. The bedouin guides chose your route carefully, leapfrogging through treacherous dune fields and across empty gravel plains to low-lying oases rich with orchards and date palms. Your great fear was that the caravan might lose its way and perish of thirst. The small bands of raiders who hovered just out of bowshot, waiting to pick off stragglers, were oddly a comfort -- at least water could be no more than a day's ride away. It was a great relief when the mountains came into view, and on the evening of the following day you crested a rocky pass and in the distance could make out the sea, and the towers of Jabba silhouetted against the sunset."),
...
("the_coast", "the coast"),
  ...
  ("s12s15_declared_war_to_control_calradia", "{s12}{s15} may attack {s16} without pretext, as a bid to extend control over all of Tohlobaria."),
  ...
  ("s21_the_s8_declared_war_as_part_of_a_bid_to_conquer_all_calradia", "{s21}. The {s8} declared war with very little pretext, as part of a bid to conquer all Tohlobaria."),
...
#----jalik quest-------------
("renegade_mercenaries", "Destroy the renegade merenary partie!"),
...
"),		
#----kingdom quests end --------  
#----The Lady of Dirim quests-------------
("for_the_empire", "Prevent the city of Dirim from falling and try to restaure the Empire."),
#--lady_of_dirim_0
("try_to_free_s10_retained_captive_at_s9", "Try to free {s10} retained captive at {s9}."),
#--
("lady_of_dirim", "Meet Finjir at Dirim"),
("lady_of_dirim_2", "Speaking with Finjir, find a way to help the Lady of Dirim"),
("lady_of_dirim_3", "Give Oath of Homage to the Empress"),
("last_legion", "Search for and Rescue General Linkadas"),
("last_legion_slaver", "Search for and Rescue General Linkadas. Try to find slaver who bought the General"),
("last_legion_gladiators", "Capture and bring 4 war veterans to Ramun the slaves trader"),
("last_legion_2", "Search for and Rescue General Linkadas. According to Ramun, general Linkadas was secretly led to the city of Darenbay ..."),
("last_legion_3", "Rescue mission is a success. Go speak with the empress..."),
#----The Lady of Dirim quests end --------  
#--pravar quest
("long_life_to_the_king", "You had a contract with Pravar to serve him as mercenary captain for a certain time."),
("siege_of_dirim", "Join the siege of Dirim  and  try to show your prowess in the presence of the Pravaran seigniory"),
("knight_of_pravar_feast", "join the king's feast and try to meet him"),
("long_life_to_the_king_knight", "You are now a knight of Pravar, you have now multiple possibilities to become more powerful and wealthy..."),
("knight_of_pravar_defector", "Find Duke Kaladus and try to persuade him to join Pravar.\
 if he refuses capture or even  kill him if it is necessary."),
#--pravar quest END
...
# Lav modifications end (custom lord notes)
	...
	#---------------------
	("baron_s12", "Baron {s12}"),
	("baronne_s12", "Baronne {s12}"),
	("baron_fief_acceptance", "You do me a great honour, {Sire/My lady}. I shall hold {s17} as your vassal, and raise an army to fight for your glory and for mine."),

	#--empress capture
   ("empress_capture_notification", "after a fierce battle, the kingdom Pravar has finally managed to capture the empress and according to some rumours, negotiations for the surrender of Dirim have already started"),

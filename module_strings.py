...
#npc16 = klethi --> Antonius
  ...
  ("npc1_intro_response_2", "peut-etre dois-je effectivement vous laisser enferm̩, vous me paraissez assez louche!"),
...
#backstory recruit pitch
  ("npc1_backstory_c", "hein... pourquoi vous riez comme ̤a ?"),
...
### use these if there is a short period of time between the last meeting 
  ...
  ("npc1_signup_2", "ah... c'est peut-etre lui que vous cherchez? votre Jirinal...il a ̩t̩ recament vendu a un esclavagiste "),

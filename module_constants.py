...
slot_item_difficulty                = 610
slot_item_weight                    = 611
# slot_item_price                     = 103 
slot_item_head_armor               = 613
slot_item_body_armor                   = 614
slot_item_leg_armor                     = 615 
...
slot_faction_reinforcements_d 		=76 #--toh 0.5 add mercenaries to caravans
...
#all spice comes overland to Khosot
#all dyes come by sea to Bilomadal
...
slto_kingdom_lady       = 6 #Usually inactive (Tohlobaria is a traditional place). However, can be made potentially active if active_npcs are expanded to include ladies
slto_kingdom_seneschal  = 7
slto_robber_knight      = 8
slto_inactive_pretender = 9
#--player's knights
slto_inactive_hero = 10
#--
...
bandits_end = "trp_black_guhulay_horseman"
...
#--player's knights
player_knights_begin = "trp_knight_9_1"
player_knights_end = "trp_fire_arm_merchant"
#--
...
upgradable_mercenary_troops_begin = "trp_mercenary_halberdier"
upgradable_mercenary_troops_end = "trp_double_sold"
#--

multiplayer_troops_begin = "trp_pravar_crossbowman_multiplayer"
multiplayer_troops_end = "trp_multiplayer_end"

multiplayer_ai_troops_begin = "trp_pravar_crossbowman_multiplayer_ai"
...
jalik_quests_begin = "qst_renegade_mercenaries"
jalik_quests_end = "qst_renegade_mercenaries"

all_items_begin = 0
all_items_end = "itm_items_end"

#--toh (0.51) kingdom's items
pravar_items_begin = "itm_pravar_cuirasse"
pravar_items_end ="itm_pravar_items_end"
dirim_items_begin = "itm_vardian_guard_armor"
dirim_items_end ="itm_dirim_items_end"
#--
...
tournament_champions_begin ="trp_jana"
tournament_champions_end ="trp_tutorial_trainer"

pravar_merc_parties_begin = "p_town_1_mercs"
pravar_merc_parties_end   = "p_town_8_mercs"

borovod_merc_parties_begin  = "p_town_8_mercs"
borovod_merc_parties_end    = "p_zendar"
...
#--(toh 0.51) kingdom quartermaster
quartermasters_begin  = "trp_pravar_quartermaster"
quartermasters_end    = "trp_local_merchant"
#--
...
startup_merchants_begin = "trp_pravar_merchant"
...
banner_meshes_begin = "mesh_banner_pravar_01"
banner_meshes_end_minus_one = "mesh_banner_baron_21"

arms_meshes_begin = "mesh_banner_pravar_01"
arms_meshes_end_minus_one = "mesh_banner_baron_21"
...
custom_banner_flag_scene_props_end = "spr_banner_pravar_01"

custom_banner_map_icons_begin = "icon_custom_banner_01"
custom_banner_map_icons_end = "icon_banner_pravar_01"

banner_map_icons_begin = "icon_banner_pravar_01"
banner_map_icons_end_minus_one = "icon_banner_baron_21"

banner_scene_props_begin = "spr_banner_pravar_01"
banner_scene_props_end_minus_one = "spr_banner_baron_21"

imifir_banners_begin_offset = 12
imifir_banners_end_offset = 23

guhulay_banners_begin_offset = 24
guhulay_banners_end_offset = 35

afirid_banners_begin_offset = 36
afirid_banners_end_offset = 47

borovod_banners_begin_offset = 48
borovod_banners_end_offset = 59

hadvog_banners_begin_offset = 60
hadvog_banners_end_offset = 71

barons_banners_begin_offset = 72
barons_banners_end_offset = 91

banners_end_offset = 147 #<--136
...
num_max_borovod_punishing_parties = 20
...
num_black_guhulay_spawn_points = 1
...
arena_tier4_prize = 100
arena_grand_prize = 300
...
#-------Tohlobaria  armoured troops ---------
tohlobarian_heavy_troop_begin = "trp_light_infantry"
tohlobarian_heavy_troop_end = "trp_knight"
#------------------------------------------
#---------Dynamic Villages and Scene Props Iterator ----
#situational_scene_var_id = 127
#-------------------------------------------------------
...
## Prebattle Orders & Deployment Begin Inspirations
...
slot_party_pref_wp_prof_decrease = slot_town_arena_melee_cur_tier

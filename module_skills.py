...
skills = [
  ...
  ("surgery","Surgery",sf_base_att_int|sf_effects_party,4,"Each point to this skill gives a 4%% chance that a mortally struck party member will be wounded rather than killed. (Party skill) - Max : 4"), 
  ...
  ("shield","Shield",sf_base_att_agi,2,"Reduces damage to shields (by 8%% per skill level) and improves shield speed and coverage. (Personal skill) - Max : 2"),
  ...
  ("power_draw","Power Draw",sf_base_att_str,6,"Lets character use more powerful bows. Each point to this skill (up to four plus power-draw requirement of the bow) increases bow damage by 14%%. (Personal skill) - Max : 6"),
  ("power_throw","Power Throw",sf_base_att_str,4,"Each point to this skill increases throwing damage by 10%%. (Personal skill) - Max : 4"),
  ("power_strike","Power Strike",sf_base_att_str,4,"Each point to this skill increases melee damage by 8%%. (Personal skill) - Max : 4"),

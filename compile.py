WRECK_VERSION = '0.6.7.5 RC2'

# DONE:
# fixed message about extra tuple elements when reporting from a sub-tuple.
# fixed syntax check for faction relations array to accept references.
# if W.R.E.C.K. is missing `colorama` library, it will automatically run in black&white mode.
# some preparatory work for plugin syntax improvement.

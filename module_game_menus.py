...
game_menus = [
  ...
  ("start_phase_2",mnf_disable_all_keys,
    "Tohlobaria, a land torn between rival kingdoms battling each other for supremacy,\
 ...
 and that whatever course you take, great adventures will await you...",
    ...
    [],
    [
		("go_to_capital",[(eq, "$current_startup_quest_phase", 0),],"Start your adventure ! ",
		   [
			(try_begin),
				(eq,"$background_answer_2",cb2_dirim),
				(party_relocate_near_party, "p_main_party", "p_town_16", 2),
			(else_try),
				(eq,"$background_answer_2",cb2_pravar),
				(party_relocate_near_party, "p_main_party", "p_town_6", 2),
			(else_try),
				(eq,"$background_answer_2",cb2_imifir),
				(party_relocate_near_party, "p_main_party", "p_town_5", 2),
			(else_try),
				(eq,"$background_answer_2",cb2_guhulay),
				(party_relocate_near_party, "p_main_party", "p_town_10", 2),
			(else_try),
				(eq,"$background_answer_2",cb2_afirid),
				(party_relocate_near_party, "p_main_party", "p_town_19", 2),
			(else_try),
				(eq,"$background_answer_2",cb2_hadvog),
				(party_relocate_near_party, "p_main_party", "p_town_1", 2),
			(else_try),
				(eq,"$background_answer_2",cb2_borovod),
				(party_relocate_near_party, "p_main_party", "p_town_8", 2),
			(else_try),
				(eq,"$background_answer_2",cb2_foreign),
				(party_relocate_near_party, "p_main_party", "p_free_port", 2),
			(try_end),
      ...
      ("tutorial_cheat",[(eq,1,0)],"{!}CHEAT!",
       [
         ...
         (party_add_members, "p_main_party", "trp_pravar_knight", 10),
         (party_add_members, "p_main_party", "trp_borovod_knight", 10),
         (party_add_members, "p_main_party", "trp_borovod_trained_archer", 10),
         (party_add_members, "p_main_party", "trp_pravar_crossbowman", 10),
...
##        (set_visitor,0,"trp_player"),
##        (set_visitor,1,"trp_borovod_veteran"),
##        (set_visitor,2,"trp_borovod_veteran"),
##        (set_visitor,3,"trp_borovod_veteran"),
##        (set_visitor,4,"trp_borovod_veteran"),
...
###       (troop_add_item, "trp_player","itm_guhulay_arrows",0),
...
##       (set_visitors, 2, "trp_pravar_sergeant", 5),
##       (set_visitors, 3, "trp_pravar_sharpshooter", 4),
##       (set_visitors, 4, "trp_pravar_man_at_arms", 8),
##       (set_visitors, 5, "trp_pravar_knight", 3),
##       (set_visitors, 6, "trp_peasant_woman", 7),
##
####     Enemy
##       (set_visitors, 16, "trp_borovod_veteran", 6),
##       (set_visitors, 17, "trp_borovod_archer", 6),
##       (set_visitors, 18, "trp_borovod_horseman", 4),
##       (set_visitors, 19, "trp_borovod_knight", 10),
##       (set_visitors, 20, "trp_borovod_guard", 6),
...
##       (set_visitor, 0, "$g_player_troop"),
##
##       (set_visitors, 1, "trp_borovod_archer", 4),
##       (set_visitors, 2, "trp_borovod_archer", 5),
##       (set_visitors, 3, "trp_borovod_axeman", 4),
##       (set_visitors, 4, "trp_borovod_horseman", 4),
##       (set_visitors, 5, "trp_borovod_footman", 2),
##       (set_visitors, 6, "trp_borovod_knight", 4),
#### ENEMY
##
...
##       (troop_equip_items, "$g_player_troop"),
#### US
##       (set_visitors, 1, "trp_borovod_veteran", 4),
##       (set_visitors, 2, "trp_borovod_archer", 3),
##       (set_visitors, 3, "trp_borovod_veteran", 4),
##       (set_visitors, 4, "trp_borovod_archer", 3),
##       (set_visitors, 5, "trp_borovod_veteran", 3),
##       (set_visitors, 6, "trp_borovod_footman", 5),
##       (set_visitors, 7, "trp_borovod_footman", 4),
##       (set_visitors, 8, "trp_borovod_archer", 3),
##
#### ENEMY
##       (set_visitors, 16, "trp_pravar_footman", 8),
##       (set_visitors, 17, "trp_pravar_crossbowman", 9),
##       (set_visitors, 18, "trp_pravar_sergeant", 7),
##       (set_visitors, 19, "trp_pravar_sharpshooter", 8),
##       (set_visitors, 20, "trp_pravar_militia", 13),
...
##
#### US
##       (set_visitors, 1, "trp_pravar_knight", 3),
##       (set_visitors, 2, "trp_pravar_sergeant", 4),
##       (set_visitors, 3, "trp_pravar_sharpshooter", 8),
##       (set_visitors, 4, "trp_pravar_man_at_arms", 8),
##       (set_visitors, 5, "trp_pravar_knight", 2),
##
####     enemy
##       (set_visitors, 16, "trp_borovod_veteran", 8),
##       (set_visitors, 17, "trp_borovod_archer", 10),
##       (set_visitors, 18, "trp_borovod_horseman", 4),
##       (set_visitors, 19, "trp_borovod_knight", 10),
##       (set_visitors, 20, "trp_borovod_guard", 7),
...
##       (set_visitor, 0, "$g_player_troop"),
##
##       (set_visitors, 1, "trp_hadvog_archer", 4),
##       (set_visitors, 2, "trp_hadvog_archer", 4),
##       (set_visitors, 3, "trp_hadvog_champion", 4),
##       (set_visitors, 4, "trp_hadvog_veteran", 5),
##       (set_visitors, 5, "trp_hadvog_warrior", 5),
##       (set_visitors, 6, "trp_hadvog_trained_footman", 8),
##
#### ENEMY
##       (set_visitors, 11, "trp_borovod_knight", 2),
##       (set_visitors, 12, "trp_borovod_guard", 6),
##       (set_visitors, 13, "trp_borovod_veteran", 8),
##       (set_visitors, 14, "trp_borovod_axeman", 10),
##       (set_visitors, 16, "trp_borovod_skirmisher", 5),
##       (set_visitors, 17, "trp_borovod_archer", 4),
##       (set_visitors, 18, "trp_borovod_marksman", 2),
##       (set_visitors, 19, "trp_borovod_skirmisher", 4),
##       (set_visitors, 20, "trp_borovod_skirmisher", 3),
##       (set_visitors, 21, "trp_borovod_skirmisher", 3),
##       (set_visitors, 22, "trp_borovod_skirmisher", 3),
##       (set_visitors, 23, "trp_borovod_archer", 2),
...
##  ),
  ...
  (
    ...
    [
    ("start_merchant",[],"Travelling merchant.",[
      (assign,"$background_type",cb_merchant),
      (assign, reg3, "$character_gender"),
	  (jump_to_menu,"mnu_start_character_2"),
    ]),
    ("start_warrior",[],"Arena fighter.",[
    ...
    ("start_cleric",[],"Cleric.",[
      (assign,"$background_type",cb_cleric),
      (assign, reg3, "$character_gender"),
  ...
  (
    ...
    [
      ("dirim",[
          ],"The Old Tohlobarian Empire ",[
      (assign,"$background_answer_2", cb2_dirim),
      (assign, reg3, "$character_gender"),
      (str_store_string,s11,"@ you are a citizen of The Empire of Dirim ..."),
	  (call_script, "script_set_player_relation_with_faction", "fac_kingdom_7", 2),
	  # (call_script, "script_set_player_relation_with_faction", "fac_galnar_clan", -5),
	  # (call_script, "script_set_player_relation_with_faction", "fac_golden_horde", -5),
	(jump_to_menu,"mnu_choose_skill"),
    ]),
      ("pravar",[
          ],"The kingdom Of Pravar",[
      (assign,"$background_answer_2", cb2_pravar),
      (assign, reg3, "$character_gender"),
      (str_store_string,s11,"@You are subject of the King of Pravar"),
	  (call_script, "script_set_player_relation_with_faction", "fac_kingdom_1", 2),
	  (call_script, "script_set_player_relation_with_faction", "fac_knights_of_doomcall",-1),
	  # (call_script, "script_set_player_relation_with_faction", "fac_the_new_order", -5),

	(jump_to_menu,"mnu_choose_skill"),
    ]),
      ("imifir",[
          ],"The Imifir Confederation",[
      (assign,"$background_answer_2",cb2_imifir),
      (assign, reg3, "$character_gender"),
      (str_store_string,s11,"@ A free man from the Imifir Confederation"),
	  (call_script, "script_set_player_relation_with_faction", "fac_kingdom_5", 2),
	  # (call_script, "script_set_player_relation_with_faction", "fac_knights_of_doomcall", -5),
	  (call_script, "script_set_player_relation_with_faction", "fac_the_new_order", 0),
	  # (call_script, "script_set_player_relation_with_faction", "fac_golden_horde", -1),
	(jump_to_menu,"mnu_choose_skill"),
    ]),
      ("guhulay",[
          ],"The Guhulay Khanate",[
      (assign,"$background_answer_2",cb2_guhulay),
      (assign, reg3, "$character_gender"),
      (str_store_string,s11,"@You are a nomad from the guhulay Khanate"),
	  (call_script, "script_set_player_relation_with_faction", "fac_kingdom_3", 2),
	  # (call_script, "script_set_player_relation_with_faction", "fac_knights_of_doomcall", -5),
	  # (call_script, "script_set_player_relation_with_faction", "fac_the_new_order", -5),
	  (call_script, "script_set_player_relation_with_faction", "fac_golden_horde", 0),
	  (jump_to_menu,"mnu_choose_skill"),
    ]),
      ("afirid",[
          ],"The Afirid Dynasty",[
      (assign,"$background_answer_2",cb2_afirid),
      (assign, reg3, "$character_gender"),
      (str_store_string,s11,"@You are from the Afiride Dynasty"),
	  (call_script, "script_set_player_relation_with_faction", "fac_kingdom_6", 2),
	  # (call_script, "script_set_player_relation_with_faction", "fac_knights_of_doomcall", -5),
	  # (call_script, "script_set_player_relation_with_faction", "fac_the_new_order", -5),
	  # (call_script, "script_set_player_relation_with_faction", "fac_golden_horde", -5),
	  # (call_script, "script_set_player_relation_with_faction", "fac_desert_tribes", -5),
	(jump_to_menu,"mnu_choose_skill"),
    ]),
	 ("hadvog",[
          ],"Kingdom Of Hadvog",[
      (assign,"$background_answer_2",cb2_hadvog),
      (assign, reg3, "$character_gender"),
      (str_store_string,s11,"@You are from the Kingdom of Hadvog"),
	  (call_script, "script_set_player_relation_with_faction", "fac_kingdom_4", 2),
	  # (call_script, "script_set_player_relation_with_faction", "fac_knights_of_doomcall", -5),
	  # (call_script, "script_set_player_relation_with_faction", "fac_the_new_order", -5),
	  # (call_script, "script_set_player_relation_with_faction", "fac_galnar_clan", -5),
	(jump_to_menu,"mnu_choose_skill"),
	 ...
	 ("borovod",[
      ...
      (assign,"$background_answer_2",cb2_borovod),
      (assign, reg3, "$character_gender"),
      (str_store_string,s11,"@You are from the Borovod Principality"),
	  (call_script, "script_set_player_relation_with_faction", "fac_kingdom_2", 2),
	  # (call_script, "script_set_player_relation_with_faction", "fac_galnar_clan", -5),
	(jump_to_menu,"mnu_choose_skill"),
    ]),
	("foreign",[
          ],"Foreign country",[
      (assign,"$background_answer_2",cb2_foreign),
      (assign, reg3, "$character_gender"),
      (str_store_string,s11,"@ You are a foreign traveller"),
	  (call_script, "script_set_player_relation_with_faction", "fac_kingdom_8", 2),
	  # (call_script, "script_set_player_relation_with_faction", "fac_knights_of_doomcall", -1),
	  # (call_script, "script_set_player_relation_with_faction", "fac_the_new_order", -1),
		# (call_script, "script_set_player_relation_with_faction", "fac_desert_tribes", -1),
		# (call_script, "script_set_player_relation_with_faction", "fac_golden_horde", -1),
        # (call_script, "script_set_player_relation_with_faction", "fac_galnar_clan", -1),
	(jump_to_menu,"mnu_choose_skill"),
    ]),
  ...
  (
    ...
    [
      ...
      (else_try),
		...
		(troop_add_item, "trp_player","itm_long_gambeson_mail"),
      ...
      (else_try),
        ...
        (troop_add_gold, "trp_player", 1000),
        (troop_set_slot, "trp_player", slot_troop_renown, 10),
		(troop_add_item, "trp_player","itm_padded_leather"),
      ...
      (else_try),
		...
		(troop_add_item, "trp_player","itm_iron_staff"),
    ...
    (else_try),
        ...
        (troop_raise_proficiency, "trp_player",wpt_archery,20),
		(troop_raise_proficiency, "trp_player",skl_riding,2),
		(troop_add_item, "trp_player","itm_sword_guhulay_1"),
    (else_try),
        (eq,"$background_answer_2",cb2_afirid),
		(troop_raise_proficiency, "trp_player",skl_riding,1),
        (troop_raise_skill, "trp_player","skl_inventory_management",1),
        (troop_raise_skill, "trp_player","skl_trade",1),
		(troop_add_item, "trp_player","itm_afirid_mace_1"),
    (else_try),
        (eq,"$background_answer_2",cb2_hadvog),
        (troop_raise_attribute, "trp_player",ca_strength,1),
		(troop_raise_skill, "trp_player","skl_shield",2),
        (troop_raise_proficiency, "trp_player",wpt_one_handed_weapon,20),
		(troop_add_item, "trp_player","itm_one_handed_war_axe_a"),
    (else_try),
        (eq,"$background_answer_2",cb2_borovod),
    ...
    (else_try),
		...
		(troop_add_item, "trp_player","itm_flintlock_pistol_1"),
		(troop_add_item, "trp_player","itm_cartridges"),
		(troop_add_item, "trp_player","itm_knife"),
	(try_end),
  ...
  ("morale_report",0,
   ...
   [
     ...
     (try_end),
	#--presence of elite troops
     (assign, reg10, "$g_player_party_morale_modifier_elite_troops"),
     (try_begin),
       (gt, reg10, 0),
	...
	#--
     ...
     (str_store_string, s1, "str_current_party_morale_is_reg5_current_party_morale_modifiers_are__base_morale__50_party_size_s2reg1_leadership_s3reg2_elite_troops_s10reg10_food_variety_s4reg3s5s6_recent_events_s7reg4_total__reg5___"),
...
("party_size_report",0,
   ...
   [(call_script, "script_game_get_party_companion_limit"),
    ...
    (try_begin),
       (gt, reg8, 0), #Bannerets #<--------
       (str_store_string, s5, "@{!} +{reg8}"),
    (else_try),
      (str_store_string, s5, "str_space"),
    (try_end),
    (try_begin),
       (gt, reg7, 0), #Marshall
       (str_store_string, s6, "@{!} +{reg7}"),
    (else_try),
      (str_store_string, s6, "str_space"),
    (try_end),
    (try_begin),
       (gt, reg6, 0), #King
       (str_store_string, s7, "@{!} +{reg6}"),
    (else_try),
      (str_store_string, s7, "str_space"),
    (try_end),

    (str_store_string, s1, "@Current party size limit is {reg5}.^Current party size modifiers are:^^Base size:  +30^Leadership: {s2}{reg1}^Charisma: {s3}{reg2}^Renown: {s4}{reg3}^^Bannerets: {s5}^Marshall: {s6}^King: {s7}^TOTAL:  {reg5}"),
    ],
    [
      ("continue",[],"Continue...",
       [(jump_to_menu, "mnu_reports"),
  ...
  ("camp_action",0,
   ...
   [
    ...
    [
      ...
      ("action_modify_banner",[(faction_slot_eq, "fac_player_supporters_faction", slot_faction_state, sfs_active)],"Modify your banner.",
       [
	   ...
	   #-------------change kingdom culture----------------------
	   ("action_change_troops",[(eq, "$players_kingdom_name_set", 1),],"Change your kingdom's culture.",
	   [
	...
	("camp_action_change_troops",0,
	   ...
	   [],
		[
		  ("Pravar",[(faction_slot_eq, "fac_kingdom_1", slot_faction_state, sfs_inactive),],"Pravar.",
		  [(faction_set_slot, "fac_player_supporters_faction",  slot_faction_tier_1_troop, "trp_pravar_recruit"),
		  (faction_set_slot, "fac_player_supporters_faction",  slot_faction_tier_2_troop, "trp_pravar_militia"),
		  (faction_set_slot, "fac_player_supporters_faction",  slot_faction_tier_3_troop, "trp_pravar_guard"),
		  (faction_set_slot, "fac_player_supporters_faction",  slot_faction_tier_4_troop, "trp_pravar_infantry"),
		  (faction_set_slot, "fac_player_supporters_faction",  slot_faction_tier_5_troop, "trp_pravar_man_at_arms"),
		  (faction_set_slot, "fac_player_supporters_faction",  slot_faction_noble_troop, "trp_pravar_squire"),
		  ...
		  ("Borovod",[(faction_slot_eq, "fac_kingdom_2", slot_faction_state, sfs_inactive),],"Borovod.",
		  [(faction_set_slot, "fac_player_supporters_faction", slot_faction_tier_1_troop, "trp_borovod_recruit"),
		  (faction_set_slot, "fac_player_supporters_faction", slot_faction_tier_2_troop, "trp_borovod_footman"),
		  (faction_set_slot, "fac_player_supporters_faction", slot_faction_tier_3_troop, "trp_borovod_guard"),
		  (faction_set_slot, "fac_player_supporters_faction", slot_faction_tier_4_troop, "trp_borovod_veteran"),
		  (faction_set_slot, "fac_player_supporters_faction", slot_faction_tier_5_troop, "trp_borovod_bardiche_master"),
		  (faction_set_slot, "fac_player_supporters_faction",  slot_faction_noble_troop, "trp_borovod_horseman"),
		  ...
		  ("Guhulay",[(faction_slot_eq, "fac_kingdom_3", slot_faction_state, sfs_inactive),],"Guhulay.",
		  [(faction_set_slot, "fac_player_supporters_faction", slot_faction_tier_1_troop, "trp_guhulay_tribesman"),
		  (faction_set_slot, "fac_player_supporters_faction", slot_faction_tier_2_troop, "trp_guhulay_skirmisher"),
		  (faction_set_slot, "fac_player_supporters_faction", slot_faction_tier_3_troop, "trp_guhulay_guard"),
		  (faction_set_slot, "fac_player_supporters_faction", slot_faction_tier_4_troop, "trp_guhulay_horse_archer"),
		  (faction_set_slot, "fac_player_supporters_faction", slot_faction_tier_5_troop, "trp_guhulay_veteran_horse_archer"),
		  (faction_set_slot, "fac_player_supporters_faction",  slot_faction_noble_troop, "trp_guhulay_lancer"),
		  ...
		  ("Hadvog",[(faction_slot_eq, "fac_kingdom_4", slot_faction_state, sfs_inactive),],"Hadvog.",
		  [(faction_set_slot, "fac_player_supporters_faction", slot_faction_tier_1_troop, "trp_hadvog_recruit"),
		  (faction_set_slot, "fac_player_supporters_faction", slot_faction_tier_2_troop, "trp_hadvog_footman"),
		  (faction_set_slot, "fac_player_supporters_faction", slot_faction_tier_3_troop, "trp_hadvog_guard"),
		  (faction_set_slot, "fac_player_supporters_faction", slot_faction_tier_4_troop, "trp_hadvog_warrior"),
		  (faction_set_slot, "fac_player_supporters_faction", slot_faction_tier_5_troop, "trp_hadvog_veteran"),
		  (faction_set_slot, "fac_player_supporters_faction",  slot_faction_noble_troop, "trp_hadvog_huskarl"),
		  ...
		  ("Imifir",[(faction_slot_eq, "fac_kingdom_5", slot_faction_state, sfs_inactive),],"Imifir.",
		  [(faction_set_slot, "fac_player_supporters_faction", slot_faction_tier_1_troop, "trp_imifir_recruit"),
		  (faction_set_slot, "fac_player_supporters_faction", slot_faction_tier_2_troop, "trp_imifir_spearman"),
		  (faction_set_slot, "fac_player_supporters_faction", slot_faction_tier_3_troop, "trp_imifir_guard"),
		  (faction_set_slot, "fac_player_supporters_faction", slot_faction_tier_4_troop, "trp_imifir_pikeman"),
		  (faction_set_slot, "fac_player_supporters_faction", slot_faction_tier_5_troop, "trp_imifir_halberdier"),
		  (faction_set_slot, "fac_player_supporters_faction",  slot_faction_noble_troop, "trp_imifir_bodyguard"),
		  ...
		  ("Afirid",[(faction_slot_eq, "fac_kingdom_6", slot_faction_state, sfs_inactive),],"Afirid.",
		  [(faction_set_slot, "fac_player_supporters_faction", slot_faction_tier_1_troop, "trp_afirid_recruit"),
		  (faction_set_slot, "fac_player_supporters_faction", slot_faction_tier_2_troop, "trp_afirid_footman"),
		  (faction_set_slot, "fac_player_supporters_faction", slot_faction_tier_3_troop, "trp_afirid_guard"),
		  (faction_set_slot, "fac_player_supporters_faction", slot_faction_tier_4_troop, "trp_afirid_horseman"),
		  (faction_set_slot, "fac_player_supporters_faction", slot_faction_tier_5_troop, "trp_afirid_heavy_horseman"),
		  (faction_set_slot, "fac_player_supporters_faction",  slot_faction_noble_troop, "trp_afirid_charif"),
		  ...
		  ("Dirim",[(faction_slot_eq, "fac_kingdom_7", slot_faction_state, sfs_inactive),],"Dirim.",
		  [(faction_set_slot, "fac_player_supporters_faction",  slot_faction_tier_1_troop, "trp_dirim_recruit"),
		  (faction_set_slot, "fac_player_supporters_faction",  slot_faction_tier_2_troop, "trp_dirim_militia"),
		  (faction_set_slot, "fac_player_supporters_faction",  slot_faction_tier_3_troop, "trp_dirim_pretorian_guard"),
		  (faction_set_slot, "fac_player_supporters_faction",  slot_faction_tier_4_troop, "trp_dirim_regular"),
		  (faction_set_slot, "fac_player_supporters_faction",  slot_faction_tier_5_troop, "trp_dirim_veteran"),
		  (faction_set_slot, "fac_player_supporters_faction",  slot_faction_noble_troop, "trp_dirim_cavalryman"),
 ...
 all your money, and ride off into the sunset....",
  ...
  (
    ...
    [
		...
		#-----black order track-------
	  (try_begin),
	   (eq, "$g_encountered_party_faction","fac_knights_of_doomcall"),
		(play_track, "track_black_order", 1),
	  (try_end),
		#-------
		#-----others tracks-------
	  # (try_begin),
	  ...
	  #------------------------
        ...
        (try_begin),
          ...
          (try_begin),
			...
			#--(toh 0.5) village qui rejoint la bataille au cote du joueur ( a regler plys tard)
          (else_try),
              (eq,"$option_village_joining",1),
    ...
    [
      ...
      [
        ...
        (else_try),
          ...
          (jump_to_scene, ":scene_to_use"),
        (else_try),
		  #-----------faction battle tactics------
		  #(assign, "$team1_faction", "$g_encountered_party_faction"),
		  #----------------------------------------
          (set_jump_mission,"mt_lead_charge"),
		  #--for the respawn trigger
		  (assign,"$p_team",0),
		  #--
          (call_script, "script_setup_random_scene"),
        (try_end),
    ...
    [
        ...
        (else_try),
          ...
          (try_begin),
            ...
            (try_begin),
				(gt, "$g_ally_party", 0),
				#--------convertir les prisonnier selon la culture de leurs liberateurs (victoire avec allies)-----
				(store_faction_of_party, ":ally_faction","$g_ally_party"),
				(party_get_num_companion_stacks, ":num_stacks","p_temp_party_2"),
				(try_for_range, ":stack_no", 0, ":num_stacks"),
					(party_stack_get_troop_id, ":stack_troop","p_temp_party_2",":stack_no"),
					(this_or_next|neg|troop_is_hero, ":stack_troop"),
					(eq, "$g_move_heroes", 1),
					(party_stack_get_size, ":stack_size","p_temp_party_2",":stack_no"),
					(store_character_level,":troop_level", ":stack_troop"),
					(try_begin),
						(is_between,":ally_faction",npc_kingdoms_begin,npc_kingdoms_end),
						(try_begin),
							(this_or_next|eq,":stack_troop","trp_paysan"),
							(eq,":stack_troop","trp_farmer"),
							(faction_get_slot, ":stack_troop", ":ally_faction", slot_faction_tier_1_troop),
						(else_try),
							(le,":troop_level",10),
							(faction_get_slot, ":stack_troop", ":ally_faction", slot_faction_tier_2_troop),
						(else_try),
							(le,":troop_level",20),
							(faction_get_slot, ":stack_troop", ":ally_faction", slot_faction_tier_4_troop),
						(else_try),
							(le,":troop_level",26),
							(faction_get_slot, ":stack_troop", ":ally_faction", slot_faction_tier_5_troop),
						(else_try),
							(gt,":troop_level",26),
				...
				(try_end),
				(call_script, "script_party_prisoners_add_party_prisoners", "p_temp_party_3", "p_temp_party_2"),
		   #---------------------------------------------------------------------------------
				(distribute_party_among_party_group, "p_temp_party_3", "$g_ally_party"),
            (try_end),
        ...
        (else_try),
          ...
          (else_try),
            (try_begin), #my kingdom
              ...
              #----------pas de royaume------------
			  # (else_try),#player took a walled center while he is a bandit.
				# (neg|is_between, "$players_kingdom", npc_kingdoms_begin, npc_kingdoms_end),
				# (neq, "$players_kingdom", "fac_player_supporters_faction"),
                # (assign, "$talk_context", tc_loot_center),
                # (change_screen_return),

                # (assign, ":best_troop", "trp_pravar_sharpshooter"),
              ...
              (else_try), #player took a walled center for player's kingdom
                ...
                (assign, ":best_troop", "trp_pravar_crossbowman"),
                (assign, ":maximum_troop_score", 0),
  ...
  (
    ...
    [
        (play_track, "track_captured", 1),
          ...
          (party_clear, "p_temp_party"),
		  (party_clear, "p_temp_party_3"),
          (call_script, "script_party_add_party_prisoners", "p_temp_party_3", "p_main_party"),
          (call_script, "script_party_prisoners_add_party_companions", "p_temp_party", "p_main_party"),
		   #--------convertir les prisonnier selon la culture de leurs liberateurs (defaite)-----
		   (store_faction_of_party, ":faction_receiving_prisoners", "$g_enemy_party"),
			(party_get_num_companion_stacks, ":num_stacks","p_temp_party_3"),
			(try_for_range, ":stack_no", 0, ":num_stacks"),
				(party_stack_get_troop_id, ":stack_troop","p_temp_party_3",":stack_no"),
				(this_or_next|neg|troop_is_hero, ":stack_troop"),
				(eq, "$g_move_heroes", 1),
				(party_stack_get_size, ":stack_size","p_temp_party_3",":stack_no"),
				(store_character_level,":troop_level", ":stack_troop"),
				(try_begin),
					(is_between,":faction_receiving_prisoners",npc_kingdoms_begin,npc_kingdoms_end),
					(try_begin),
						(this_or_next|eq,":stack_troop","trp_paysan"),
						(eq,":stack_troop","trp_farmer"),
						(faction_get_slot, ":stack_troop", ":faction_receiving_prisoners", slot_faction_tier_1_troop),
					(else_try),
						(le,":troop_level",10),
						(faction_get_slot, ":stack_troop", ":faction_receiving_prisoners", slot_faction_tier_2_troop),
					(else_try),
						(le,":troop_level",20),
						(faction_get_slot, ":stack_troop", ":faction_receiving_prisoners", slot_faction_tier_4_troop),
					(else_try),
						(le,":troop_level",26),
						(faction_get_slot, ":stack_troop", ":faction_receiving_prisoners", slot_faction_tier_5_troop),
					(else_try),
						(gt,":troop_level",26),
						(faction_get_slot, ":stack_troop", ":faction_receiving_prisoners", slot_faction_noble_troop),
					(try_end),
				(else_try),
						(assign, ":stack_troop","trp_bandit"),
				(try_end),
...
##            (eq, ":random_attribute", ca_intelligence),
  ...
  (
    ...
    "none",
    [
        (str_store_party_name, 1,"$g_encountered_party"),#attacker
    ...
    [
      ...
      [
		...
		(try_begin),
			...
			(store_relation, ":enemy_faction_relation", ":enemy_faction", "fac_player_faction"),
			(call_script, "script_change_player_relation_with_faction", ":enemy_faction", -10),
			(gt, ":enemy_faction_relation", 3),
        ...
        (call_script, "script_calculate_battle_advantage"),
        (set_battle_advantage, reg0),
		#--pravar quest : helping pravar's lord
		# (try_begin),
			# (troop_slot_ge, "trp_player", slot_troop_renown, 100),
			# (store_faction_of_party, ":ally_faction","$g_ally_party"),
			# (eq,":ally_faction","fac_kingdom_1")





			# (store_relation, ":ally_faction_relation", ":ally_faction", "fac_player_faction"),
			# (gt, ":ally_faction_relation", 3),
			# (call_script, "script_change_player_honor", -1),
		# (try_end),
		#--
        (set_party_battle_mode),
		...
		#-----------faction battle tactics------
		# (store_faction_of_party, "$team0_faction","$g_ally_party"),
		# (store_faction_of_party, "$team1_faction","$g_enemy_party"),
		#----------------------------------------
        (set_jump_mission,"mt_lead_charge"),
		#--for the respawn trigger
		(assign,"$p_team",0),
...
#      ("zendar_leave",[],"Leave town.",[[leave_encounter],[change_screen_return]]),
  ...
  #-------------ruins----------------
	(
		"ruins",0,
		"You arrive at an ancients imperial stronghold ruins ...   ",
		"none",
		[
		],
		[
			(
				"explore",[(eq,"$g_dark_priest",0),],"Explore the ruins ...",
				[

					(modify_visitors_at_site,"scn_castle_ruins"),
					(reset_visitors,0),
					(set_visitors,1,"trp_order_priest",1),
					(set_visitors,2,"trp_npc19",1),
					#(set_visitors,3,"trp_npc20",1),
					(assign,"$g_artisan_dialog_end",1),
					(play_track,"track_ruins",1),
					(set_jump_mission,"mt_ruins_occupants"),
					(jump_to_scene,"scn_castle_ruins"),
					(change_screen_mission),
				]
			),
			(
				"enter",[(main_party_has_troop,"trp_npc20"),],"Take a walk around",
				[
					(modify_visitors_at_site,"scn_castle_ruins"),
					(reset_visitors,0),
					(set_visitors,1,"trp_npc19",1),
					(set_visitors,2,"trp_npc20",1),
					(remove_member_from_party,"trp_npc20", "p_main_party"),
					(assign,"$g_artisan_dialog_end",0),
					(set_jump_mission,"mt_ruins_securised"),
					(jump_to_scene,"scn_castle_ruins"),
					(change_screen_mission),
				]
			),
			(
				"enter",[(check_quest_active,"qst_the_phoenix_2"),],"Take a walk around",
				[
					(modify_visitors_at_site,"scn_castle_ruins"),
					(reset_visitors,0),
					(set_visitors,1,"trp_npc19",1),
			...
			(
				"enter",[(check_quest_succeeded,"qst_the_phoenix_2"),],"Take a walk around",
				[
					(modify_visitors_at_site,"scn_castle_ruins"),
					(reset_visitors,0),
					(set_visitors,1,"trp_npc19",1),
					(set_visitors,2,"trp_npc20",1),
					(set_visitors,3,"trp_jalik_mercenary",1),
					(set_visitors,4,"trp_jalik_mercenary",1),
					(set_jump_mission,"mt_ruins_protected"),
					(jump_to_scene,"scn_castle_ruins"),
					(change_screen_mission),
				]
			),
  ...
  #-------------White Order camp----------------
	(
		"new_order_camp",0,
		"You have discovered a hidden White Order camp",
		"none",
		[
		],
		[
			(
				"enter",[(troop_slot_eq, "trp_pedran", slot_troop_met_previously, 0),],"Enter ...",
				[
					(modify_visitors_at_site,"scn_white_order_camp"),
					(reset_visitors,0),
					(set_visitors,1,"trp_order_gunner",1),
					(set_visitors,2,"trp_order_gunner",1),
					(set_visitors,3,"trp_order_gunner",1),
					(set_visitors,4,"trp_order_gunner",1),
					(set_visitors,5,"trp_order_billman",1),
					(set_visitors,6,"trp_order_gunner",1),
					(set_visitors,7,"trp_pedran",1),
					(set_visitors,8,"trp_order_gunner",1),
					(set_visitors,9,"trp_charob",1),
					(set_jump_mission,"mt_new_order_camp"),
					(jump_to_scene,"scn_white_order_camp"),
					(change_screen_mission),
				]
			),
			(
				"attack",[(troop_slot_eq, "trp_pedran", slot_troop_met_previously, 1),(neg|check_quest_active, "qst_last_legion_slaver"),],"Attack that camp...",
				[
					(modify_visitors_at_site,"scn_white_order_camp"),
					(reset_visitors,0),
					(set_visitors,1,"trp_order_gunner",2),
					(set_visitors,2,"trp_order_gunner",2),
					(set_visitors,3,"trp_order_gunner",2),
					(set_visitors,4,"trp_order_gunner",2),
					(set_visitors,5,"trp_order_billman",2),
					(set_visitors,6,"trp_order_gunner",2),
					(set_visitors,7,"trp_order_billman",2),
					(set_visitors,8,"trp_order_gunner",2),
					(set_visitors,9,"trp_charob",1),
					(set_party_battle_mode),
					(set_battle_advantage, 0),
					(set_jump_mission,"mt_new_order_camp_assault"),
					(jump_to_scene,"scn_white_order_camp"),
					(change_screen_mission),
    ...
    [
      ...
      ("join_siege_with_allies",[(neg|troop_is_wounded, "trp_player")], "Join the next assault.",
       [
		   ...
		   #--(toh 0.5) pravar quest - siege of dirim - battle advantage
		   (try_begin),
				(check_quest_active,"qst_siege_of_dirim"),
				(eq, "$g_encountered_party","p_town_16"),
				(assign,reg0,0),
		   (try_end),
		   #--(toh 0.5) pravar quest - siege of dirim - battle advantage END
           (set_battle_advantage, reg0),
           (set_party_battle_mode),
           (try_begin),
...
##                                                   (change_screen_map_conversation, ":cur_guard")
      ...
      ("castle_start_siege",
       [
           ...
           (gt, reg(0), 5),
		    #---le centre n'etait pas receament pille par le joueur--------
		   (party_get_slot,":last_sack", "$g_encountered_party"  , slot_center_last_time_sacked),
		   (assign, ":continue",0),
		   (try_begin),
				(gt,":last_sack",0),
				(store_add, ":next_sack", ":last_sack", 30),
				(store_current_day,":cur_day"),
				(lt,":cur_day",":next_sack"),
				(assign, ":continue",0),
			(else_try),
				(assign, ":continue",1),
		   (try_end),
    ...
    [
        ...
        (else_try),
          ...
          (eq, "$g_enemy_surrenders", 1),
			...
			(try_begin),
			 #---verifie si le centre n'etait pas receament pille par le joueur--------
				(party_slot_eq,"$g_encountered_party", slot_party_type, spt_castle),
				(party_get_slot,":last_sack", "$g_encountered_party"  , slot_center_last_time_sacked),
				(gt,":last_sack",0),
				(store_add, ":next_sack", ":last_sack", 30),
				(store_current_day,":cur_day"),
				(lt,":cur_day",":next_sack"),
				(display_message,"@ chateau pris juste apres son pillage"),
				(jump_to_menu, "mnu_center_already_sacked"),
		   #-----------------------------------------------------
			(else_try),
...
# TODO: To use for the future:
 ...
 Now the attackers are pouring into the streets. IF you can defeat them, you can perhaps turn the tide and save the day."),
        (try_begin),
          ...
          (le, "$g_enemy_fit_for_battle", 0),
			#--pravar quest
			(try_begin),#meeting the lord
				(check_quest_active,"qst_siege_of_dirim"),
				(eq, "$g_encountered_party","p_town_16"),
				(neq, "$talk_context", tc_camp_talk),
				(assign, "$talk_context", tc_siege_commander),
				(str_store_string, s1, "@The First assault against Dirim has failed, but the siege continues..\
 Morale is low, but you and your men are trying somehow to recover before the next attack, when suddenly  you are summoned by a Pravaran lord "),

				# (quest_get_slot, ":giver_troop", "qst_long_life_to_the_king", slot_quest_giver_troop),
				# (call_script, "script_setup_troop_meeting", ":giver_troop", -1),

			(else_try),#infiltration
				(check_quest_active,"qst_siege_of_dirim"),
				(eq, "$g_encountered_party","p_town_16"),
				(eq, "$talk_context", tc_camp_talk),
				(str_store_string, s1, "@As expected, you and some of your men have managed to infiltrate Dirim. \
  But it will not be easy to get out ... alive!"),
				# (quest_get_slot, ":giver_troop", "qst_long_life_to_the_king", slot_quest_giver_troop),
				# (call_script, "script_setup_troop_meeting", ":giver_troop", -1),
			#--
			(else_try),
    ...
    [
      ("continue",[],
       ...
       [
			...
			(try_begin),
			   #-- pravar quest (dirim siege - meeting the vassal)
				(eq, "$talk_context", tc_siege_commander),
				(agent_set_hit_points,":player_agent",80),
				#(heal_party,"p_main_party"),
				# (set_jump_mission, "mt_besiege_inner_battle_town_alley"),
				# (set_party_battle_mode),
				# (jump_to_scene, "scn_town_16_alley"),
				(quest_get_slot, ":giver_troop", "qst_long_life_to_the_king", slot_quest_giver_troop),

				(set_jump_mission, "mt_siege_camp_meeting"),
				(modify_visitors_at_site, "scn_dirim_siege_camp"),
				(reset_visitors),
				(set_visitor, 0, "trp_player"),
				(set_visitor, 1, "trp_pravar_man_at_arms"),
				(set_visitor, 2, "trp_pravar_man_at_arms"),
				(set_visitor, 3, "trp_pravar_man_at_arms"),
				(set_visitor, 4, "trp_pravar_man_at_arms"),
				(set_visitor, 5, "trp_pravar_footman"),
				(set_visitor, 6, "trp_pravar_man_at_arms"),
				(set_visitor, 7, "trp_pravar_man_at_arms"),
				(set_visitor, 8, "trp_pravar_knight"),
				(set_visitor, 9, ":giver_troop"),
				(jump_to_scene, "scn_dirim_siege_camp"),
				(change_screen_mission),
			   #--
			(else_try),
			   #-- pravar quest (dirim siege - meeting the vassal)
				...
				(quest_get_slot, ":giver_troop", "qst_long_life_to_the_king", slot_quest_giver_troop),
				(set_jump_mission, "mt_besiege_inner_battle_town_alley"),
				(modify_visitors_at_site, "scn_town_16_alley"),
				(reset_visitors),
				(set_visitor, 0, "trp_player"),
				(set_visitor, 1, ":giver_troop"),
				(set_visitor, 2, "trp_finjir"),
				(set_visitor, 3, "trp_dirim_pretorian_guard"),
				(set_visitor, 4, "trp_dirim_pretorian_guard"),
				(set_visitor, 5, "trp_dirim_veteran"),
				(set_visitor, 6, "trp_dirim_cavalryman"),
				(set_visitor, 7, "trp_dirim_militia"),
				(set_visitor, 8, "trp_dirim_footman"),
				(set_visitor, 9, "trp_dirim_forest_hunter"),
				(jump_to_scene, "scn_town_16_alley"),
				(change_screen_mission),
			   #--
			(else_try),
    ...
    [
      ...
      [
        (call_script, "script_cf_village_recruit_volunteers_cond"),
		 #---------player cannot  recruit from villages---------
		 #(party_slot_eq, "$current_town", slot_town_lord, "trp_player"),
		 #------------------------------------------------------
       ]
       ,"Recruit Volunteers.",
...
#      (call_script, "script_loot_player_items", 0),
 ...
 Or perhaps, it was given to them by someone who wanted to arrange a suitable ending to your life.",
	...
	(
		"retake_castle_succeeded",mnf_disable_all_keys,
		"The surprise was total for the few soldiers who occupied the place. The castle is again under your control",
		"none",
		[
		],
		[
		("continue",[],"Continue...",
			[
			   ...
			   (rest_for_hours, 0, 0, 0), #stop resting
				...
				(call_script, "script_give_center_to_faction_aux", "p_outpost", "fac_player_supporters_faction"),
				(call_script, "script_give_center_to_lord", "p_outpost", "trp_player", 0),
				(party_add_particle_system,  "p_outpost", "psys_map_village_fire_smoke"),
				(party_clear_particle_systems,  "p_outpost"),
				(change_screen_map),
			]),
		],
	),
	(
		"retake_castle_failed",mnf_disable_all_keys,
		"The surprise was total for the few soldiers who occupied the place. The castle is again under your control.",
		"none",
		[
		],
...
#NPC companion changes end
 ...
 and then put the buildings to the torch. From the coins and valuables that are found, you get your share of {reg1} denars.",
    ...
    [
		...
		#-------changer relation avec tout les villages de la meme faction-----
		(try_for_range, ":other_village", villages_begin, villages_end),
			(store_faction_of_party, ":other_village_faction", ":other_village"),
			(eq,":other_village_faction",":village_faction"),
			(call_script, "script_change_player_relation_with_center", ":other_village", -3),
		(try_end),
		#-----------------------------------------------------------------------
...
#NPC companion changes end
  ...
  (
    ...
    [
		...
		(try_end),
		#-----------------------------------------
        #--(toh 0.51) mercenary auto upgrade
        (try_begin),
            (gt,"$war_experience",0),
			...
			(try_for_range, ":stack_no", 0, ":stack_num"),
                ...
                (party_stack_get_troop_id, ":stack_troop", "p_main_party", ":stack_no"),
                (neg|troop_is_hero, ":stack_troop"),
                (is_between,":stack_troop",upgradable_mercenary_troops_begin,upgradable_mercenary_troops_end),
                (party_remove_members_wounded_first,"p_main_party",":stack_troop",1),
                (try_begin),
                    (eq,":stack_troop","trp_mercenary_halberdier"),
                    (party_add_members, "p_main_party", "trp_heavy_mercenary_halberdier", 1),
                (else_try),
                    (eq,":stack_troop","trp_mercenary_crossbowman"),
                    (party_add_members, "p_main_party", "trp_heavy_mercenary_crossbowman", 1),
                (else_try),
                    (eq,":stack_troop","trp_nord_mercenary"),
                    (party_add_members, "p_main_party", "trp_heavy_nord_mercenary", 1),
                (else_try),
                    (eq,":stack_troop","trp_mercenary_cavalry"),
                    (party_add_members, "p_main_party", "trp_heavy_mercenary_cavalry", 1),
                (else_try),
                    (eq,":stack_troop","trp_sellsword"),
                    (party_add_members, "p_main_party", "trp_heavy_sellsword", 1),
                (else_try),
                    (eq,":stack_troop","trp_mercenary_archer"),
                    (party_add_members, "p_main_party", "trp_heavy_mercenary_archer", 1),
                (else_try),
                    (eq,":stack_troop","trp_south_spearman"),
                    (party_add_members, "p_main_party", "trp_heavy_south_spearman", 1),
                (else_try),
                    (eq,":stack_troop","trp_south_cavalry"),
                    (party_add_members, "p_main_party", "trp_heavy_south_cavalry", 1),
                (else_try),
                    (eq,":stack_troop","trp_mounted_archer"),
                    (party_add_members, "p_main_party", "trp_heavy_mounted_archer", 1),
                (try_end),
                (val_sub,"$war_experience",1),
            (try_end),
            (assign,"$war_experience",0),
        (try_end),
        #--
        (call_script, "script_update_center_recon_notes", "$current_town"),
      ...
      [
       ...
       [
           ...
           (else_try),
			...
			#----------l'Ordre attaque----------
			(else_try),
				(eq, "$fortress_accident",0),
				(eq,"$current_town","p_outpost"),
				(jump_to_menu, "mnu_fortress_accident"),
			#---------------------------------
		   (else_try),
             (assign, "$town_entered", 1),
      ...
      ("join_tournament", [(neg|is_currently_night),(party_slot_ge, "$current_town", slot_town_has_tournament, 1),]
       ...
       [
           (try_begin),
				...
				(lt,":golds",200),
				(display_message,"@You don't have enough money",0xFFFFAAAA),
		   (else_try),
      ...
      "Take a walk around the streets.",
       [
         ...
         (try_begin),
		   ...
		   #--------------darenbay secret prison-----------
		   (try_begin),
				(eq,"$current_town","p_town_15"),
               (set_visitors, 13, "trp_npc17", 1),
			   (set_visitors, 25, "trp_imifir_crossbowman", 1),
               # (set_visitors, 26, "trp_imifir_guard", 1),
               # (set_visitors, 27, "trp_imifir_trained_spearman", 1),
               # (set_visitors, 28, "trp_imifir_guard", 1),
		   #-----------------------------------------------
         ...
         (else_try),
           ...
           (else_try),
             (assign,reg0,"trp_borovod_veteran"),
             (assign,reg1,"trp_borovod_veteran"),
             (assign,reg2,"trp_borovod_trained_archer"),
             (assign,reg3,"trp_borovod_footman"),
           (try_end),
           (shuffle_range,0,4),
		   ...
		   #---------darenbay secret prison guard-------
		   (try_begin),
			(eq,"$current_town","p_town_15"),
			(neg|check_quest_concluded,"qst_last_legion_2"),
			(set_visitor, 13, "trp_imifir_halberdier"),
		   (try_end),
		   #--------------------------------------------
...
#					(assign, "$g_last_assassination_attempt_perpetrator", ":lord"),
             ...
             #---------------npc2 spawn------------
            (try_begin),
               (troop_slot_eq, "trp_npc2", slot_troop_occupation, 0),
			   (check_quest_finished, "qst_renegade_mercenaries"),
			   (eq,"$current_town","p_free_port"),
               (set_visitor, ":cur_entry", "trp_npc2"),
               (val_add, ":cur_entry", 1),
            (try_end),
			 #--------------------------------------------
             #---------------npc3 spawn------------
            (try_begin),
			   ...
			   (troop_slot_eq, "trp_npc3", slot_troop_occupation, 0),
			   (troop_slot_eq, "trp_npc3", slot_troop_met_previously, 1),
			   (eq,"$current_town","p_town_6"),
               (set_visitor, ":cur_entry", "trp_npc3"),
               (val_add, ":cur_entry", 1),
            (try_end),
			 #--------------------------------------------
			 (try_begin),
             ...
             (try_begin),
               ...
               (try_begin),
                 ...
                 #(assign, ":troop_of_merchant", "trp_pravar_merchant"),
               (else_try),
                 (eq, "$g_encountered_party_faction", "fac_kingdom_2"),
                 (assign, ":troop_of_merchant", "trp_borovod_merchant"),
               (else_try),
                 (eq, "$g_encountered_party_faction", "fac_kingdom_3"),
                 (assign, ":troop_of_merchant", "trp_guhulay_merchant"),
               (else_try),
                 (eq, "$g_encountered_party_faction", "fac_kingdom_4"),
                 (assign, ":troop_of_merchant", "trp_hadvog_merchant"),
               (else_try),
                 (eq, "$g_encountered_party_faction", "fac_kingdom_5"),
                 (assign, ":troop_of_merchant", "trp_imifir_merchant"),
               (else_try),
                 (eq, "$g_encountered_party_faction", "fac_kingdom_6"),
                 (assign, ":troop_of_merchant", "trp_afirid_merchant"),
               (try_end),
...
#           (scene_slot_eq,  ":scene", slot_scene_visited, 1), #check if scene has been visited before to allow entry from menu. Otherwise scene will only be accessible from the town center.
       ...
       [
           ...
           (else_try),
             ...
             (set_visitor, 44, "trp_veteran_fighter"),
             (set_jump_entry, 50),
       ...
       [
         ...
         (else_try),
           ...
           (else_try),
             ...
             (faction_get_slot, ":troop_prison_guard", ":town_original_faction", slot_faction_prison_guard_troop),
           (try_end),
           #------------- probleme entry point 24 (prison guard) pour outpost--------
		   (try_begin),
				(neq,":cur_castle_exterior","scn_outpost_exterior"),
				(neq,":cur_castle_exterior","scn_my_castle_exterior"),
				(set_visitor, 24, ":troop_prison_guard"),
			(else_try),
				(set_visitor, 23, "trp_npc20"), #<----j'en profite pour metre l'armurier ici
		   (try_end),
		   #------------------------------------------------------------------------------
           (assign, ":guard_no", 40),
		...
		#------Darenbay secret prison------
      ("darenbay_prison",#<-- menu item 9
       [(eq, 1, 0)],
       "Never: Enter the secret prison.",
       [
           (try_begin),
			#(check_quest_active,"qst_last_legion_2"),
			(eq,"$talk_context",tc_prison_break),
			(all_enemies_defeated),
			(set_jump_mission,"mt_darenbay_secret_prison"),
			(modify_visitors_at_site,"scn_town_15_secret_prison"),
			(reset_visitors),
			#(set_visitor, 1, "trp_npc17"),
			(set_visitor, 2, "trp_pravar_footman"),
			(set_visitor, 3, "trp_pravar_guard"),
			(set_jump_entry, 0),
			(jump_to_scene,"scn_town_15_secret_prison"),
			(scene_set_slot, "scn_town_15_secret_prison", slot_scene_visited, 1),
			(assign, "$talk_context", tc_prison_break),
			(change_screen_mission),
           (else_try),
             (display_message,"str_door_locked",0xFFFFAAAA),
           (try_end),
        ],"Door to the secret prison."),
		#------------------------------------




		 #------recruit volunteers  in castles/towns ----------
		# ("recruit_nobles",[
		# (call_script, "script_cf_town_castle_recruit_volunteers_cond"),
		# ]
		# ,"Hire some local militia",
		# [
			# (try_begin),
				# (call_script, "script_cf_enter_center_location_bandit_check"),
			# (else_try),
		...
		# ]),
		#------------------------------------------------------
		 #------recruit speciality troops ----------
		("speciality_troops",[
		(eq,"$current_town","p_outpost"),
		(check_quest_finished, "qst_master_armorer"),
		(main_party_has_troop, "trp_paysan"),
		#(main_party_has_troop, "trp_farmer"),
		#(call_script, "script_cf_speciality_troops_recruit_cond"),
		]
		,"Train and equip new soldiers",
		[
			(jump_to_menu, "mnu_recruit_speciality_troops"),
		]),
		#------------------------------------------------------
     ("town_enterprise",
      [
...
##          ]),
	...
	##diplomacy begin
      ...
      (else_try),
         ...
         (assign, ":can_meet_guild_master", 1),
      (else_try),
         #Always enable this in Pravar for the sake of playability, since
  ...
  (
	...
	(try_begin),
		(this_or_next|neq, "$players_kingdom", "$g_encountered_party_faction"),
			(neg|troop_slot_ge, "trp_player", slot_troop_renown, 50),
		(neg|troop_slot_ge, "trp_player", slot_troop_renown, 125),
		(gt, "$g_player_tournament_placement", 3),#--------3 au lieu de 4
		(faction_slot_eq, "$g_encountered_party_faction", slot_faction_ai_state, sfai_feast),
		(faction_slot_eq, "$g_encountered_party_faction", slot_faction_ai_object, "$g_encountered_party"),
 ...
 In addition to honour, fame and glory, you earn a prize of {reg9} denars. {s8}",
    ...
    [
        ...
        (call_script, "script_change_player_relation_with_center", "$current_town", 3),#---au lieu de 1

		(assign, reg9, 1000),#---au lieu de 200
  ...
  (
    ...
    [
        ...
        (try_begin),
          ...
          (party_set_slot, "$current_town", slot_town_player_odds, ":player_odds"),
			#---------ajouter or et renomme meme si tu perd-----
			(try_begin),
				(ge,"$g_tournament_cur_tier",2),
				(assign,":price",200),
				(assign,":renown",4),
				(assign,":multip","$g_tournament_cur_tier"),
				(val_sub,":multip",1),
				(val_mul,":price",":multip"),
				(val_mul,":renown",":multip"),
    ...
    [
      ...
      ("tournament_join_next_fight", [], "Fight in the next round.",
       [
		   ...
		   (try_begin),
		     (gt, "$g_player_tournament_placement", 2),#----3 au lieu de 4
           ...
           (set_jump_mission, "mt_arena_melee_fight"),
		   #-------equipements de tournois annules-----
		   #-------------------------------------------
           (jump_to_scene, ":arena_scene"),
           (change_screen_mission),
        ]),
  ...
  (
    ...
    [
        ...
        (call_script, "script_get_num_tournament_participants"),
        (assign, ":num_participants", reg0),
		#(display_message,"@ {reg0} participants"),
...
##	(call_script, "script_merchant_road_info_to_s42", "$g_encountered_party"),
 ...
 You must flee back through the gates before all the guards in the town come down on you!",
    ...
    [
      ("sneak_caught_fight",[],"Try to fight your way out!",
       [
           ...
           #  (assign,reg3,":tier_2_troop"),
           #(else_try),
           #  (assign,reg0,"trp_pravar_skirmisher"),
           #  (assign,reg1,"trp_pravar_crossbowman"),
           #  (assign,reg2,"trp_pravar_infantry"),
           #  (assign,reg3,"trp_pravar_crossbowman"),
           #(try_end),
           #(assign,reg4,-1),
           #(shuffle_range,0,5),
           #(set_visitor,2,reg0),
  ...
  (
	...
	#--last legion quest
	(try_begin),
		(troop_slot_eq, "trp_npc17", slot_troop_mission_participation, mp_prison_break_escaped),
        (assign, "$talk_context", tc_hero_freed),
        (assign, reg14, "trp_npc17"),
        (call_script, "script_setup_troop_meeting", "trp_npc17", -1),
        (troop_set_slot, "trp_npc17", slot_troop_mission_participation, -1),
	(try_end),
	#--
...
#-----white order camp results----------
   (
    "new_order_camp_defeat",0,
    "Your enemies must have taken you up for dead and left you as meal for crows.\
 However, it seems that none of your wound were lethal,\
 and altough you feel awful, you find out that can still walk.\
 Now it's time to prepare your revenge.",
    "none",
    [
      ],
    [
   ...
   (
    "new_order_camp_victory",mnf_scale_picture,
    "The last of your enemies was overcome.Unfortunately the enemy have could give alarm and probably other forces are on the way to reconquer the fort",
    "none",
    [
	(set_background_mesh, "mesh_pic_victory"),
      ],
    [
      ("continue",[],"Continue...",
       [
			(call_script, "script_set_player_relation_with_faction", "fac_the_new_order", -10),
			(str_store_string, s17, "@Pedran of White Order managed to escape."),
			(call_script, "script_change_troop_renown", "trp_player", 20),
			(party_add_xp,"p_main_party", 1000),
			(troop_add_items, "trp_player", "itm_hand_canon", 3),
			(troop_add_items, "trp_player", "itm_cartridges", 3),
			(party_add_members, "p_main_party", "trp_npc1", 1),
			(change_screen_return),
			(try_for_parties,":party_id"),
				(store_faction_of_party, ":party_faction", ":party_id"),
				(eq,":party_faction","fac_the_new_order"),
				(party_set_ai_behavior, ":party_id", ai_bhvr_travel_to_point),
				(party_get_position, pos5, "p_new_order_camp"),
				(party_set_ai_target_position, ":party_id", pos5),
			(try_end),
 ...
 The guards are outraged and beat you savagely before throwing you back into the cell for God knows how long...",
  ...
  (
    ...
    [
		...
		#---------- l'armee noir a pris le chateau--------
		(try_begin),
			(eq,":capturer_faction","fac_knights_of_doomcall"),
			#--> supprimer l'armee noir
			(try_for_parties, ":party_no"),
				(party_get_template_id,":party_template",":party_no"),
				(eq, ":party_template", "pt_black_army"),
				(remove_party, ":party_no"),
			(try_end),
			#----------------------------
			(jump_to_menu,"mnu_castle_break"),	#<--- un menu si le joueur est prisonnier de son propre chateau
		#-----------------------------------
		(else_try),
		  (party_is_active, "$capturer_party"),
		  #(store_faction_of_party, ":capturer_faction", "$capturer_party"),
  ...
  (
    "castle_break",0,
    "After days of imprisonment, you are finally ready to lead your remaining men and retake your castle.",
    "none",
    [
      (play_cue_track, "track_escape"),
      ],
    [
      ("continue",[],"Continue...",
       [
           (assign, "$g_player_is_captive", 0),
           (rest_for_hours, 0, 0, 0), #stop resting
			#------mettre les acteurs en place----
		   	(modify_visitors_at_site,"scn_outpost_exterior"),
			#(set_party_battle_mode),
			(reset_visitors),
			(set_visitor,7,"trp_player"),
			(set_visitors,8,"trp_imprisoned_veteran",8),
			(set_visitors,9,"trp_order_follower",4),
			# (set_visitors,24,"trp_light_infantry",5),
			# (set_visitors,40,"trp_order_follower",1),
			# (set_visitors,41,"trp_order_follower",1),
			# (set_visitors,42,"trp_order_follower",1),
			# (set_visitors,43,"trp_order_follower",1),
			# (set_visitors,44,"trp_order_follower",1),
			#(set_visitors,3,"trp_npc20",1),
			(set_jump_mission,"mt_castle_break"),
			(jump_to_scene,"scn_outpost_exterior"),
           (change_screen_mission),
        ]),
    ]
  ),
...
#        (call_script, "script_change_player_relation_with_troop", ":faction_marshall", -3),
 ...
 He will surely be offended if you do not take the offer...",
    ...
    [
      ...
      ("faction_reject",[],"Decline the invitation. (Declare independence)",
 ...
 You shall have to find him and give him your oath in person. {s5}",
	...
	(
		"fortress_accident",0,
		"You have an accident! ^^ Part of the ancient wall has collapsed near you, and bad luck you got a fragment on the head. The injury wasn't serious, but you are immobilized for a few hours",
		"none",
		[
		...
		[
			("continue",[],"Continue...",
				[
					#----un groupe de l'ordre griffon noir veullent reprendre le chateau----

						(set_spawn_radius, 4),
						(spawn_around_party,"p_castle_13","pt_black_army"),#spawned party id is stored in reg0
						(assign,":party_no",reg0),
					    (party_set_ai_behavior, ":party_no", ai_bhvr_attack_party),
						(party_set_ai_object, ":party_no", "p_outpost"),

						(assign, "$auto_enter_town", "$current_town"),
						(assign, "$g_town_visit_after_rest", 1),
						(assign, "$g_last_rest_center", "$current_town"),
						(assign, "$g_last_rest_payment_until", -1),
						(rest_for_hours, 24 , 5, 0), #rest while not attackable
						(change_screen_return),

						(assign, "$fortress_accident",1),
						#(party_set_ai_initiative,":party_no",100),
						#(party_set_slot, ":party_no", slot_center_is_besieged_by, "p_outpost"),
						# (call_script, "script_party_set_ai_state", ":party_no", spai_besieging_center, "p_outpost"),
					   # (party_set_ai_behavior, ":party_no", ai_bhvr_attack_party),
					   # (party_set_ai_object, ":party_no", "p_outpost"),
  ...
  (
    ...
    [
		...
		(str_store_troop_name, s8, "$g_notification_menu_var1"),#==la on va choper le nom de "l'inviteur" (dans s8)
		(store_faction_of_troop, ":host_faction", "$g_notification_menu_var1"),
		(str_store_faction_name, s9, ":host_faction"),

		#--(toh 0.5) pravar quest - king's invitation
		(try_begin),
			(check_quest_succeeded,"qst_siege_of_dirim"),			#--verification : quete de pravar est bien finie
			(neg|check_quest_active, "qst_knight_of_pravar_feast"),		#--verification : quete de l'invitation n'est pas active
			(neg|check_quest_finished, "qst_knight_of_pravar_feast"),	#--verification : quete de l'invitation n'est pas terminee
			(eq,"$g_notification_menu_var1","trp_kingdom_1_lord"),							#-- le roi de pravar est bien l'hote de la fete
			(setup_quest_text,"qst_knight_of_pravar_feast"), 		#-- le titre/texte de la quete (il est dans le ficher module_quest)
			(str_store_string, s2, "str_knight_of_pravar_feast"),	#-- le texte/description de la quete (il est dans le ficher module_strings), cette "operation" l'enmagaziner dans le "registre" s1 (utiliser pour stoquer les chaines de caracteres (strings)
			#--et ce s2 est utilise par le script ci-dessous pour integrer la description dans la quete !
			(call_script, "script_start_quest", "qst_knight_of_pravar_feast", "trp_kingdom_1_lord"), #-- et enfin on demarre la quete !
		(try_end),
		#--
...
#		(str_store_faction_name, s9, "$players_kingdom"),
  ...
  (
    ...
    "Tohlobaria Conquered by One Kingdom^^{s1} has defeated all rivals and stands as the sole kingdom.",
    "none",
    [
      (str_store_faction_name, s1, "$g_notification_menu_var1"),
      (set_fixed_point_multiplier, 100),
    ...
    [
	  ...
	  [
	    ...
	    (else_try),
	      ...
	      (try_begin),
	        (eq, ":starting_town_faction", "fac_kingdom_1"), #player selected pravar city as starting town.
	        (assign, ":scene_to_use", "scn_lair_forest_bandits"),
	      (else_try),
	        (eq, ":starting_town_faction", "fac_kingdom_2"), #player selected Borovod city as starting town.
	        (assign, ":scene_to_use", "scn_lair_taiga_bandits"),
	      (else_try),
	        (eq, ":starting_town_faction", "fac_kingdom_3"), #player selected Guhulay city as starting town.
	        (assign, ":scene_to_use", "scn_lair_steppe_bandits"),
	      (else_try),
	        (eq, ":starting_town_faction", "fac_kingdom_4"), #player selected Hadvog city as starting town.
	        (assign, ":scene_to_use", "scn_lair_sea_raiders"),
	      (else_try),
	        (eq, ":starting_town_faction", "fac_kingdom_5"), #player selected Imifir city as starting town.
	        (assign, ":scene_to_use", "scn_lair_mountain_bandits"),
	      (else_try),
	        (eq, ":starting_town_faction", "fac_kingdom_6"), #player selected Afirid city as starting town.
	        (assign, ":scene_to_use", "scn_lair_desert_bandits"),
	      (try_end),
	    (try_end),
...
#-----------chateau deja pille-------------------------
  (
    "center_already_sacked",mnf_scale_picture,
    "This castle is already sacked!\
 ------",
    "none",
    [
		(set_background_mesh, "mesh_pic_looted_village"),
...
#--siege of dirim
  (
    "message_siege_of_dirim",mnf_scale_picture,
    "Final siege of Dirim is started, time is come to decide the fate of the empire!",
    "none",
    [
		(set_background_mesh, "mesh_pic_siege_of_dirim"),
    ],
    [
		("Continue",[],"Continue...",
			[
				(change_screen_map),
				#--pravar quest
				(check_quest_active,"qst_long_life_to_the_king"),
				(setup_quest_text,"qst_siege_of_dirim"),
				(str_store_string, s2, "str_siege_of_dirim"),
				(call_script, "script_start_quest", "qst_siege_of_dirim", -1),
				#--
			]
		),
    ],
...
#-----------recruit volunteers in castles/towns-------------------------
  ...
  (
    ...
    [#(store_faction_of_party, ":cur_faction", "$current_town"),
     ...
     (party_get_free_companions_capacity, ":free_capacity", "p_main_party"),
     (store_troop_gold, ":gold", "trp_player"),
     (store_div, ":gold_capacity", ":gold", 50),#--600 per man
    (assign, ":party_capacity", ":free_capacity"),
     (val_min, ":party_capacity", ":gold_capacity"),
     (try_begin),
       (gt, ":party_capacity", 0),
     ...
     (else_try),
      (store_mul, reg6, ":volunteer_amount", 50),
       ...
       (else_try),
         (str_store_string, s18, "@{reg5} {s3} volunteer to follow you."),
       (try_end),
       (set_background_mesh, "mesh_pic_castle_recruit"),
     (try_end),
    ],
    [
      ("continue_not_enough_gold",
 ...
 (
    ...
    [
     #(party_get_slot, ":volunteer_troop", "$current_town", slot_center_volunteer_troop_type),
	#-- (toh 0.5) player can recruit kingdom's troops from allied towns (and castles)
	(store_faction_of_party, ":center_faction", "$current_town"),
	(try_begin),
		(this_or_next|eq, ":center_faction", "fac_player_supporters_faction"),
		(eq, ":center_faction", "fac_player_faction"),
		(faction_get_slot, ":volunteer_troop", "fac_player_supporters_faction", slot_faction_tier_2_troop),
	(else_try),
		(is_between, "$players_kingdom", npc_kingdoms_begin, npc_kingdoms_end),
		(eq, ":center_faction", "$players_kingdom"),
		(faction_get_slot, ":volunteer_troop", "$players_kingdom", slot_faction_tier_2_troop),
	(else_try),
		(assign, ":volunteer_troop", "trp_militia"),
	(try_end),
	(party_get_slot, ":volunteer_amount", "$current_town", slot_center_volunteer_troop_amount),
	(party_get_free_companions_capacity, ":free_capacity", "p_main_party"),
	(store_troop_gold, ":gold", "trp_player"),
...
#-----------recruit speciality troops-------------------------
   (
	...
	#(store_faction_of_party, ":cur_faction", "$current_town"),
	 ...
	 #------calculer le nombre de volontaire dans la main_party
	 (party_get_num_companion_stacks, ":num_stacks","p_main_party"),
	 (try_for_range, ":i_stack", 0, ":num_stacks"),
		...
		(try_begin),
			...
			(val_add,":volunteer_amount",":stack_size"),
		(try_end),
	 (try_end),
     ...
     (else_try),
       ...
       (try_begin),
         (eq, reg5, 1),
         (str_store_string, s18, "@One volunteer ready."),
       (else_try),
         (str_store_string, s18, "@{reg5}  volunteers ready."),
       (try_end),
       (set_background_mesh, "mesh_pic_recruits"),
     (try_end),
    ],
  ...
  #-------------------------------
  #--empress capture notificcation
  (
    "empress_capture",mnf_scale_picture|mnf_disable_all_keys,
    "after a fierce battle, the kingdom Pravar has finally managed to capture the empress and according to some rumours, negotiations for the surrender of Dirim have already started",
    "none",
    [
          (set_background_mesh, "mesh_pic_prisoner_fem"),
    ],
  ...
  #--npcs list
  # (
    # "npcs_list",mnf_scale_picture|mnf_disable_all_keys,
    # "active npcs list:^{s11}",
    # "none",
    # [
          # (str_store_string, s11, "@----"),
		  # (set_background_mesh, "mesh_pic_castle_recruit"),
		  # (try_for_range, ":cur_troop",heroes_begin, heroes_end),
			  # (str_store_troop_name, s12, ":cur_troop"),
			  # (str_store_string, s11, "@{!}{s11}^{s12}"),
		  # (try_end),
    # ],
    # [
  ...
  #--
 #--(toh 0.5) mod option
  ("mod_options",menu_text_color(0xFF000000)|mnf_disable_all_keys,
    "{!}",
  "none", [],
    [
     ("option_village_joining_battle",
       ...
       [
			...
			(else_try),
				(eq, "$option_village_joining", 0),
				(assign, "$option_village_joining", 1),
			(try_end),
		]
      ),
     ...
     # ("motion_death",
		...
		# ],"{reg1?Disable:Enable} running death animations.",
       # [
			# (try_begin),
				# (eq, "$option_motion_death", 1),
				# (assign, "$option_motion_death", 0),
			# (else_try),
				# (eq, "$option_motion_death", 0),
				# (assign, "$option_motion_death", 1),
			# (try_end),
		# ]
      # ),
     ...
     # ("volley_fire",
		# [
			# (assign, reg1, "$option_volley_fire"),
		# ],"{reg1?Disable:Enable} volley fire for the AI.",
       # [
			# (try_begin),
				# (eq, "$option_volley_fire", 1),
				# (assign, "$option_volley_fire", 0),
			# (else_try),
				# (eq, "$option_volley_fire", 0),
				# (assign, "$option_volley_fire", 1),
			# (try_end),
		# ]
      # ),
     ...
     # ("volley_fire",
		# [
			# (assign, reg1, "$option_voice_order"),
		# ],"{reg1?Disable:Enable} voice orders.",
       # [
			# (try_begin),
				# (eq, "$option_voice_order", 1),
				# (assign, "$option_voice_order", 0),
			# (else_try),
				# (eq, "$option_volley_fire", 0),
				# (assign, "$option_voice_order", 1),
			# (try_end),
		# ]
      # ),
  ...
  #--(toh 0.5) mod option end
      ("player_permanent_death",0,
   "-------------------GAME OVER-------------------",
   "none",
   [
   (set_background_mesh, "mesh_pic_menu_death"),
   (play_track, "track_death"),
   ],
    [
      ("continue", [], "Continue...",
       [

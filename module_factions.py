...
##  ("rebel_peasants","Rebel Peasants", 0, 0.5,[("borovods",-0.5),("player_faction",0.0)], []),
  ...
  ("disciplined","disciplined", 0, 0.5,[("outlaws",-0.5),("peasant_rebels", -0.1),("deserters", -0.5),("mountain_bandits", -0.05),("forest_bandits", -0.05),("player_supporters_faction",0),("player_faction",0),("knights_of_doomcall",-1),("sons_of_mekhresh",-1),("galnar_clan",-1)], [], 0xcf535f),
...
#--pretenders factions
  ("galnar_clan","Galnar Clan", 0, 0.5,[("kingdom_4",-1),("kingdom_7",-0.6),("kingdom_2",-0.6),("merchants",-0.5),("player_faction",-0.1),("disciplined",-0.5)], [], 0x888ffe),
#--
